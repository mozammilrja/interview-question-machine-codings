            ...
            (t.bindToInput = function (i, n) {
              ...
              return (
                ...
                n.syncWithChartWidget &&
                  ...
                  (h = function (t, e) {
                    return (
                      !e && (t === u.symbol.value() || t === u.seriesShortSymbol.value() || void 0)
                    );
                  }),
                  n.syncOnBlur &&
                    i.on('blur', function () {
          ...
          this.each(function () {
            ...
            r ? (o = !0) : (r = { step: +s.data('step') || 1 }),
              ...
              o ||
                ...
                (n = $('<div class="tv-ticker__btn tv-ticker__btn--down">').html(u).appendTo(e)),
            ...
            (i = i || {}),
              ...
              t
                ? ((a = t.prop('ownerDocument')),
                  ...
                  i.fadeIn
                    ? t.css({ left: h, top: p }).hide().fadeIn('fast')
                    : i.smooth
              ...
              e.doNotCloseOnBgClick ||
                setTimeout(function () {
                  $(n).on('mousedown.closeDialog', function (o) {
                    var s = $(o.target).parents().andSelf();
                    s.is(t) ||
