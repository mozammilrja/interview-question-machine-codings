webpackJsonp([6], {
      ...
      inherit(o, a),
          ...
          for (o = o || {}, c = {}, b = this, _ = 0; _ < e.inputs.length; _++) {
            ...
            if (
              ...
              if (
                ...
                e.name === C(g.STYLE_RANGE) && 'phantomBars' === T && (L = k.find('tr')),
                (x = $('<td' + (o.nameColspan ? ' colspan = "' + o.nameColspan + '"' : '') + '/>')),
                x.addClass('propertypage-name-label'),
                x.html(y(f, S)),
                (e.name === C(g.STYLE_RANGE) && 'phantomBars' === T) || x.appendTo(L),
                (P = $(
                  '<td' + (o.valueColspan ? ' colspan = "' + o.valueColspan + '"' : '') + '/>',
                )),
                P.appendTo(L),
                (B = null),
                w.options)
              )
                for (B = $("<select id='" + S + "' />"), E = 0; E < w.options.length; E++)
                  (R = w.options[E]),
                    $("<option value='" + R + "'>" + $.t(R) + '</option>').appendTo(B);
              else
                (F = 'bool' === w.type ? 'checkbox' : 'text'),
                  (B = $("<input id='" + S + "' type='" + F + "' />"));
              B.appendTo(P),
                (e.name === C(g.STYLE_RANGE) && 'phantomBars' === T) || B.css('width', '100px'),
                e.name === C(g.STYLE_RANGE) && 'phantomBars' === T && x.appendTo(L),
                (I = 'Change ' + f),
                w.options
                  ? this.bindControl(new h(B, i.inputs[T], null, !0, this.model(), I))
                  : 'integer' === w.type
                  ? ((D = [l(w.defval)]),
                    w.min && D.push(s(w.min)),
                    w.max && D.push(r(w.max)),
                    this.bindControl(new d(B, i.inputs[T], D, !1, this.model(), I)),
                    B.addClass('ticker'))
                  : 'float' === w.type
                  ? ((D = [p(w.defval)]),
                    w.min &&
                      ((((e.id === C(g.STYLE_RENKO) || e.id === C(g.STYLE_PNF)) &&
                        'boxSize' === w.id) ||
                        (e.id === C(g.STYLE_KAGI) && 'reversalAmount' === w.id)) &&
                        null !== (A = this._model.model().mainSeries().symbolInfo()) &&
                    ...
                    B.addClass('ticker'))
                  : 'text' === w.type
                  ? this.bindControl(new d(B, this._property.inputs[T], null, !1, this.model(), I))
                  : 'bool' === w.type &&
                    this.bindControl(new u(B, i.inputs[T], !0, this.model(), I)),
                B.change(n),
                (c[w.id] = L);
            }
          }
        ...
        (o.prototype._prepareSeriesStyleLayout = function (e, i, o, n) {
          ...
          this._isShowStyleSwitcher() &&
            ...
            $('<option value=' + g.STYLE_BARS + '>' + $.t('Bars') + '</option>').appendTo(a),
            $('<option value=' + g.STYLE_CANDLES + '>' + $.t('Candles') + '</option>').appendTo(a),
            $(
              '<option value=' + g.STYLE_HOLLOW_CANDLES + '>' + $.t('Hollow Candles') + '</option>',
            ).appendTo(a),
            this._isJapaneseChartsAvailable() &&
              $(
                '<option value=' + g.STYLE_HEIKEN_ASHI + '>' + $.t('Heikin Ashi') + '</option>',
              ).appendTo(a),
            $('<option value=' + g.STYLE_LINE + '>' + $.t('Line') + '</option>').appendTo(a),
            $('<option value=' + g.STYLE_AREA + '>' + $.t('Area') + '</option>').appendTo(a),
            $('<option value=' + g.STYLE_BASELINE + '>' + $.t('Baseline') + '</option>').appendTo(
              a,
            ),
            a.css('width', '100px').appendTo(y),
            this.switchStyle(),
            this.bindControl(new h(a, n.style, parseInt, !0, this.model(), 'Change Series Style'))),
            ...
            (x = this.addLabeledRow($e, 'Color Bars Based on Previous Close', S)),
            $('<td>').append(S).prependTo(x),
            (x = this.addLabeledRow(Te, 'Candles')),
            $('<td>').prependTo(x),
            $('<td>').append(C).appendTo(x),
            $('<td>').append(m).appendTo(x),
            (x = this.addLabeledRow(Te, 'Borders', L)),
            $('<td>').append(L).prependTo(x),
            $('<td>').append(f).appendTo(x),
            $('<td>').append(v).appendTo(x),
            (x = this.addLabeledRow(Te, 'Wick', k)),
            $('<td>').append(k).prependTo(x),
            $('<td>').append(w).appendTo(x),
            $('<td>').append(T).appendTo(x),
            this.bindControl(
              new c(C, n.candleStyle.upColor, !0, this.model(), 'Change Candle Up Color'),
            ),
            this.bindControl(
              new c(m, n.candleStyle.downColor, !0, this.model(), 'Change Candle Down Color'),
            ),
            this.bindControl(
              new u(k, n.candleStyle.drawWick, !0, this.model(), 'Change Candle Wick Visibility'),
            ),
            this.bindControl(
              new c(w, n.candleStyle.wickUpColor, !0, this.model(), 'Change Candle Wick Up Color'),
            ),
            this.bindControl(
              new c(
                T,
            ...
            $('<td>').prependTo(x),
            $('<td>').append(P).appendTo(x),
            $('<td>').append(B).appendTo(x),
            (x = this.addLabeledRow(fe, 'Borders', D)),
            $('<td>').append(D).prependTo(x),
            $('<td>').append(F).appendTo(x),
            $('<td>').append(I).appendTo(x),
            (x = this.addLabeledRow(fe, 'Wick', V)),
            $('<td>').append(V).prependTo(x),
            $('<td>').append(E).appendTo(x),
            $('<td>').append(R).appendTo(x),
            this.bindControl(
              new c(
                P,
            ...
            (x = this.addLabeledRow(me, 'Color Bars Based on Previous Close', A)),
            $('<td>').append(A).prependTo(x),
            (W = $("<input type='checkbox'/>")),
            (x = this.addLabeledRow(me, 'HLC Bars', W)),
            $('<td>').append(W).prependTo(x),
            (M = this.addColorPickerRow(Le, 'Up Color')),
            (O = this.addColorPickerRow(Le, 'Down Color')),
            this.bindControl(new c(M, n.barStyle.upColor, !0, this.model(), 'Change Bar Up Color')),
            this.bindControl(
              new c(O, n.barStyle.downColor, !0, this.model(), 'Change Bar Down Color'),
            ),
            this.bindControl(
              new u(
                A,
            ...
            $('<option value=' + g.STYLE_LINE_TYPE_STEP + '>' + $.t('Step') + '</option>').appendTo(
              G,
            ),
            G.appendTo(N),
            ...
            $('<td>').append(j).appendTo(x),
            $('<td>').append(q).appendTo(x),
            this.bindControl(
              new h(z, n.lineStyle.priceSource, null, !0, this.model(), 'Change Price Source'),
            ),
            this.bindControl(
              new h(G, n.lineStyle.styleType, parseInt, !0, this.model(), 'Change Line Type'),
            ),
            this.bindControl(new c(j, n.lineStyle.color, !0, this.model(), 'Change Line Color')),
            this.bindControl(
              new b(q, n.lineStyle.linewidth, !0, this.model(), 'Change Line Width'),
            ),
            n.haStyle &&
              ...
              (ee = $("<input type='checkbox' class='visibility-switch'/>").data(
                'hides',
                $(K).add(J),
              )),
              (te = $("<input type='checkbox'/>")),
              (x = this.addLabeledRow(we, $.t('Color Bars Based on Previous Close'), te)),
              $('<td>').append(te).prependTo(x),
              (x = this.addLabeledRow(ve, $.t('Candles'))),
              $('<td>').prependTo(x),
              $('<td>').append(U).appendTo(x),
              $('<td>').append(Y).appendTo(x),
              (x = this.addLabeledRow(ve, $.t('Borders'), X)),
              $('<td>').append(X).prependTo(x),
              $('<td>').append(Z).appendTo(x),
              $('<td>').append(Q).appendTo(x),
              (x = this.addLabeledRow(ve, $.t('Wick'), ee)),
              $('<td>').append(ee).prependTo(x),
              $('<td>').append(K).appendTo(x),
              $('<td>').append(J).appendTo(x),
              this.bindControl(
                new c(U, n.haStyle.upColor, !0, this.model(), 'Change Heikin Ashi Up Color'),
              ),
              this.bindControl(
                new c(Y, n.haStyle.downColor, !0, this.model(), 'Change Heikin Ashi Down Color'),
              ),
              this.bindControl(
                new u(
                  ee,
            ...
            this._isJapaneseChartsAvailable() && t.enabled('japanese_chart_styles'),
            (ie = _()),
            (x = this.addLabeledRow(Se, 'Price Source')),
            $('<td colspan="3">').appendTo(x).append(ie),
            (oe = this.createColorPicker()),
            (ne = this.createLineWidthEditor()),
            (x = this.addLabeledRow(Se, 'Line')),
            $('<td>').appendTo(x).append(oe),
            $('<td colspan="2">').appendTo(x).append(ne),
            (ae = this.createColorPicker()),
            (se = this.createColorPicker()),
            (x = this.addLabeledRow(Se, 'Fill')),
            $('<td>').appendTo(x).append(ae),
            $('<td>').appendTo(x).append(se),
            this.bindControl(
              new h(ie, n.areaStyle.priceSource, null, !0, this.model(), 'Change Price Source'),
            ),
            this.bindControl(
              new c(oe, n.areaStyle.linecolor, !0, this.model(), 'Change Line Color'),
            ),
            this.bindControl(
              new b(ne, n.areaStyle.linewidth, !0, this.model(), 'Change Line Width'),
            ),
            this.bindControl(
              new c(
                ae,
            ...
            $('<td colspan="3">').appendTo(x).append(re),
            this.bindControl(
              new h(re, n.baselineStyle.priceSource, null, !0, this.model(), 'Change Price Source'),
            ),
            (le = this.createColorPicker()),
            (pe = this.createLineWidthEditor()),
            (x = this.addLabeledRow(xe, window.t('Top Line'))),
            $('<td>').appendTo(x).append(le),
            $('<td>').appendTo(x).append(pe),
            this.bindControl(
              new c(le, n.baselineStyle.topLineColor, !0, this.model(), 'Change Top Line Color'),
            ),
            this.bindControl(
              new b(pe, n.baselineStyle.topLineWidth, !0, this.model(), 'Change Top Line Width'),
            ),
            (de = this.createColorPicker()),
            (he = this.createLineWidthEditor()),
            (x = this.addLabeledRow(xe, window.t('Bottom Line'))),
            $('<td>').appendTo(x).append(de),
            $('<td>').appendTo(x).append(he),
            this.bindControl(
              new c(
                de,
            ...
            $('<td>').appendTo(x).append(ce),
            $('<td>').appendTo(x).append(ue),
            this.bindControl(
              new c(
                ce,
            ...
            $('<td>').appendTo(x).append(be),
            $('<td>').appendTo(x).append(ye),
            this.bindControl(
              new c(
                be,
            ...
            (Ce = [l(n.baselineStyle.baseLevelPercentage.value()), r(100), s(0)]),
            this.bindControl(
              new d(
                ge,
  ...
  1111: function (e, t, i) {
    ...
    function o() {
      var e = $('<select />');
      return (
        $('<option value="' + a.LeftToRight + '">' + $.t('Left') + '</option>').appendTo(e),
        $('<option value="' + a.RightToLeft + '">' + $.t('Right') + '</option>').appendTo(e),
        e
      );
    }
    var n, a, s;
  ...
  1112: function (e, t, i) {
    ...
    function o() {
      var e = $('<select />');
      return (
        $('<option value="' + a.PlotType.Line + '">' + $.t('Line') + '</option>').appendTo(e),
        $(
          '<option value="' +
        ...
        $('<option value="' + a.PlotType.StepLine + '">' + $.t('Step Line') + '</option>').appendTo(
          e,
        ),
        $(
          '<option value="' + a.PlotType.Histogram + '">' + $.t('Histogram') + '</option>',
        ).appendTo(e),
        $(
          '<option value="' +
            a.PlotType.Cross +
        ...
        $('<option value="' + a.PlotType.Area + '">' + $.t('Area') + '</option>').appendTo(e),
        $(
          '<option value="' +
        ...
        $('<option value="' + a.PlotType.Columns + '">' + $.t('Columns') + '</option>').appendTo(e),
        $('<option value="' + a.PlotType.Circles + '">' + $.t('Circles') + '</option>').appendTo(e),
        e
      );
    }
    var n, a;
  ...
  320: function (e, t, i) {
    ...
    function n(e, t, i) {
      s.call(this, e, t), (this._study = i), (this._property = e), this.prepareLayout();
    }
    var a = i(823),
      s = a.PropertyPage,
    ...
    inherit(o, s),
      (o.prototype.prepareLayout = function () {
            ...
            this._study.isBgColorerPlot(n)
              ...
              ? ((l = { id: s, type: 'ohlc' }),
                this._study.isOHLCBarsPlot(n)
                  ...
                  : this._study.isOHLCCandlesPlot(n) && this._prepareLayoutForCandlesPlot(n, l))
          ...
          for (n = 0; n < p.childCount(); n++)
            (u = p[n]),
              (u.isHidden && u.isHidden.value()) ||
                ...
                (v = this.createLabeledCell(f, T).appendTo(m).addClass('propertypage-name-label')),
                (S = $('<td/>')),
                S.appendTo(m),
                ...
                this.bindControl(new h(F, u.linestyle, parseInt, !0, this.model(), V)),
              ...
              O.isHidden ||
                ...
                O.palette
                  ? ((m = $('<tr class="line"/>')),
                    ...
                    (T = $("<input type='checkbox' class='visibility-switch'/>")),
                    T.appendTo(w),
                    this.bindControl(new c(T, u.visible, !0, this.model(), V + ' visibility')),
                    this.createLabeledCell(W, T).appendTo(m).addClass('propertypage-name-label'),
                    m.appendTo(this._table),
        ...
        for (G in t.graphics) {
          j = t.graphics[G];
          for (q in j)
            (u = this._property.graphics[G][q]), o['_createRow_' + G].call(this, this._table, u);
        }
        (U = this._table.find('.visibility-switch.plot-visibility-switch')),
          ...
          k.isScriptStrategy(t) &&
            ((K = this._prepareOrdersSwitches()), (this._table = this._table.add(K))),
          this.loadData();
      }),
      (o.prototype._prepareOrdersSwitches = function () {
        var e,
          ...
          p = $('<tr>').appendTo(r),
          d = $('<input id="' + l + '" type="checkbox">').appendTo($('<td>').appendTo(p));
        return (
          $('<label for="' + l + '">' + $.t('Trades on Chart') + '</label>').appendTo(
            $('<td>').appendTo(p),
          ),
          (e = 'chart-orders-labels-switch_' + Date.now().toString(36)),
          (t = $('<tr>').appendTo(r)),
          (i = $('<input id="' + e + '" type="checkbox">').appendTo($('<td>').appendTo(t))),
          $('<label for="' + e + '">' + $.t('Signal Labels') + '</label>').appendTo(
            $('<td>').appendTo(t),
          ),
          (o = 'chart-orders-qty-switch_' + Date.now().toString(36)),
          (n = $('<tr>').appendTo(r)),
          (a = $('<input id="' + o + '" type="checkbox">').appendTo($('<td>').appendTo(n))),
          $('<label for="' + o + '">' + $.t('Quantity') + '</label>').appendTo(
            $('<td>').appendTo(n),
          ),
          (s = this._study.properties()),
          this.bindControl(
            new c(d, s.strategy.orders.visible, !0, this.model(), 'Trades on chart visibility'),
          ),
          this.bindControl(
            new c(i, s.strategy.orders.showLabels, !0, this.model(), 'Signal labels visibility'),
          ),
          this.bindControl(
            new u(i, s.strategy.orders.visible, !0, this.model(), 'Signal labels visibility', !0),
          ),
          this.bindControl(
            new c(a, s.strategy.orders.showQty, !0, this.model(), 'Quantity visibility'),
          ),
          this.bindControl(
            new u(a, s.strategy.orders.visible, !0, this.model(), 'Quantity visibility', !0),
          ),
          r
        );
      }),
      (o.prototype._prepareLayoutForPlot = function (e, t) {
        ...
        f
          ...
          : ((i = $('<tr class="line"/>')),
            ...
            (n = $("<input type='checkbox' class='visibility-switch plot-visibility-switch'/>")),
            n.appendTo(o),
            (a = $.t(this._study.properties().styles[m].title.value(), { context: 'input' })),
            this.createLabeledCell(a, n).appendTo(i).addClass('propertypage-name-label'),
            (s = $('<td/>')),
            s.appendTo(i),
            s.addClass('colorpicker-cell'),
            (r = C(s)),
            ...
            this.bindControl(new c(n, w.visible, !0, this.model(), k)),
            this.bindControl(new b(r, w.color, !0, this.model(), k, w.transparency)),
            this.bindControl(
              new y(p, w.linewidth, !0, this.model(), k, this._study.metaInfo().isTVScript),
            ),
            this.bindControl(new h(u, w.plottype, parseInt, !0, this.model(), k)),
            this.bindControl(new c(_, w.trackPrice, !0, this.model(), 'Change Price Line')));
      }),
      (o.prototype._prepareLayoutForBarsPlot = function (e, t) {
        ...
        g.appendTo(this._table),
          ...
          (n = p.title.value()),
          this.createLabeledCell(n, o).appendTo(g).addClass('propertypage-name-label'),
          h
      ...
      (o.prototype._prepareLayoutForShapesPlot = function (e, t) {
        ...
        v.appendTo(this._table),
          ...
          (n = $.t(this._study.properties().styles[u].title.value(), { context: 'input' })),
          this.createLabeledCell(n, o).appendTo(v).addClass('propertypage-name-label'),
          (a = $('<td/>')),
          a.appendTo(v),
          (s = w()),
          s.appendTo(a),
          ...
          _
            ...
            : ((v = $('<tr class="line"/>')),
              ...
              p.addClass('colorpicker-cell'),
              (d = C(p)),
              this.bindControl(new b(d, y.color, !0, this.model(), f, y.transparency)));
      }),
      ...
      (o.prototype._prepareLayoutForPalette = function (e, t, i, o, n, a) {
        ...
        for (r in i.colors)
          (l = o.colors[r]),
            ...
            (g = C(u)),
            this.bindControl(new b(g, l.color, !0, this.model(), n, B.transparency)),
            !E &&
              ...
              m.appendTo(_),
              this.bindControl(
                new y(m, l.width, !0, this.model(), n, this._study.metaInfo().isTVScript),
              ),
              (w = $('<td>')),
              w.appendTo(p),
              0 === s &&
                ((T = v()),
                T.appendTo(w),
                this.bindControl(new h(T, B.plottype, parseInt, !0, this.model(), n)),
                (f = $("<input type='checkbox'>")),
                (L = $('<td colspan="4">').css({ whiteSpace: 'nowrap' })),
                (k = $('<span>').html($.t('Price Line'))),
                (S = $('<span>')),
                S.append(f),
                L.append(S).append(k).appendTo(p),
                this.bindControl(new c(f, B.trackPrice, !0, this.model(), 'Change Price Line')))),
            s++;
      }),
      (o.prototype._prepareLayoutForArrowsPlot = function (e, t) {
        ...
        u.appendTo(this._table),
          ...
          (o = $("<input type='checkbox' class='visibility-switch'/>")),
          o.appendTo(i),
          (n = $.t(this._study.properties().styles[p].title.value(), { context: 'input' })),
          this.createLabeledCell(n, o).appendTo(u).addClass('propertypage-name-label'),
          (a = $('<td/>')),
          a.appendTo(u),
          ...
          this.bindControl(new b(s, d.colorup, !0, this.model(), h, d.transparency)),
          this.bindControl(new b(l, d.colordown, !0, this.model(), h, d.transparency));
      }),
      (o.prototype._findPlotPalette = function (e, t) {
        ...
        if (this._study.isBarColorerPlot(o) || this._study.isBgColorerPlot(o))
          ...
          for (i = 0; i < r.length; i++)
            if (
              r[i].target === n &&
              (this._study.isSelfColorerPlot(i) || this._study.isOHLCColorerPlot(i))
            ) {
      ...
      (o.prototype._prepareStudyPropertiesLayout = function () {
        var e = $('<table class="property-page study-properties" cellspacing="0" cellpadding="2">'),
        ...
        return (
          ...
          'Compare@tv-basicstudies' === this._study.metaInfo().id &&
            ...
            $('<td>').append(t).appendTo(i),
            this.bindControl(
              new h(t, this._study.properties().minTick, null, !0, this.model(), 'Change MinTick'),
            )),
      ...
      (o.prototype._putStudyDefaultStyles = function (e, t) {
        var i,
          ...
          p = this._study;
        return (
          (!p.properties().linkedToSeries || !p.properties().linkedToSeries.value()) &&
          ...
          (this._pane = l),
          this._pane &&
            (-1 !== this._pane.leftPriceScale().dataSources().indexOf(this._study)
              ? (i = 'left')
              : -1 !== this._pane.rightPriceScale().dataSources().indexOf(this._study)
              ? (i = 'right')
              : this._pane.isOverlay(this._study) && (i = 'none')),
          i &&
            ((o = this),
            (n = { left: $.t('Scale Left'), right: $.t('Scale Right') }),
            o._pane.actionNoScaleIsEnabled(p) && (n.none = $.t('Screen (No Scale)')),
      ...
      (o.prototype._prepareFilledAreaBackground = function (e, t, i, o, n) {
        ...
        return (
          ...
          a.appendTo(p),
          this.createLabeledCell(o, a).appendTo(l).addClass('propertypage-name-label'),
          (s = $('<td/>')),
          s.appendTo(l),
          s.addClass('colorpicker-cell'),
          (r = C(s)),
      ...
      (o._createRow_horizlines = function (e, t) {
        ...
        $('<td>').append(n).appendTo(i),
          ...
          this.bindControl(new c(n, t.visible, !0, this.model(), 'Change ' + o + ' visibility')),
          this.bindControl(new b(a, t.color, !0, this.model(), 'Change ' + o + ' color')),
          this.bindControl(new h(r, t.style, parseInt, !0, this.model(), 'Change ' + o + ' style')),
          this.bindControl(new y(s, t.width, !0, this.model(), 'Change ' + o + ' width'));
      }),
      ...
      (o._createRow_hlines = function (e, t) {
        ...
        $('<td>').append(r).appendTo(a),
          ...
          this.bindControl(new c(r, t.visible, !0, this.model(), 'Change ' + s + ' visibility')),
          this.bindControl(new b(l, t.color, !0, this.model(), 'Change ' + s + ' color')),
          this.bindControl(new h(d, t.style, parseInt, !0, this.model(), 'Change ' + s + ' style')),
          this.bindControl(new y(p, t.width, !0, this.model(), 'Change ' + s + ' width')),
          this.bindControl(new c(u, t.showPrice, !0, this.model(), 'Change ' + s + ' show price')),
          t.enableText.value() &&
            ((a = this.addRow(e)),
            ...
            this.bindControl(new c(i, t.showText, !0, this.model(), 'Change ' + s + ' show text')),
            (o = TradingView.createTextPosEditor()),
            $('<td>').append(o.render()).appendTo(a),
            this.bindControl(
              new h(o, t.textPos, parseInt, !0, this.model(), 'Change ' + s + ' text position'),
            ),
            (n = this.createFontSizeEditor()),
            $('<td colspan="2">').append(n).appendTo(a),
            this.bindControl(
              new h(n, t.fontSize, parseInt, !0, this.model(), 'Change ' + s + ' font size'),
            ));
      }),
      (o._createRow_hhists = function (e, t) {
        var i,
          ...
          _ = this.addRow(e),
          m = T();
        $('<td>').append(m).appendTo(_),
          this.createLabeledCell(u, m).appendTo(_),
          this.bindControl(new c(m, t.visible, !0, this.model(), 'Change ' + u + ' Visibility')),
          (_ = this.addRow(e)),
          (i = $('<input/>')),
          i.attr('type', 'text'),
          i.addClass('ticker'),
          this.createLabeledCell($.t('Width (% of the Box)'), i).appendTo(_),
          $('<td>').append(i).appendTo(_),
          (o = [p(40)]),
          o.push(r(0)),
          o.push(l(100)),
          this.bindControl(new g(i, t.percentWidth, o, !1, this.model(), 'Change Percent Width')),
          (_ = this.addLabeledRow(e, 'Placement')),
          (n = f()),
          $('<td>').append(n).appendTo(_),
          this.bindControl(
            new h(n, t.direction, null, !0, this.model(), 'Change ' + u + ' Placement'),
          ),
          (_ = this.addRow(e)),
          (a = $("<input type='checkbox'>")),
          $('<td>').append(a).appendTo(_),
          this.createLabeledCell($.t('Show Values'), a).appendTo(_),
          this.bindControl(
            new c(a, t.showValues, !0, this.model(), 'Change ' + u + ' Show Values'),
          ),
          (_ = this.addRow(e)),
          (s = this.createColorPicker()),
          this.createLabeledCell($.t('Text Color'), s).appendTo(_),
          $('<td>').append(s).appendTo(_),
          this.bindControl(
            new b(s, t.valuesColor, !0, this.model(), 'Change ' + u + ' Text Color'),
          );
        for (d in t.colors)
          isNumber(parseInt(d, 10)) &&
            ...
            $('<td>').append(y[d]).appendTo(_),
            $('<td>').append(C[d]).appendTo(_),
            this.bindControl(
              new b(C[d], t.colors[d], !0, this.model(), 'Change ' + y[d] + ' color'),
            ));
      }),
      (o._createRow_backgrounds = function (e, t) {
        ...
        $('<td>').append(o).appendTo(i),
          ...
          $('<td>').append(a).appendTo(i),
          this.bindControl(new c(o, t.visible, !0, this.model(), 'Change ' + n + ' visibility')),
          this.bindControl(
            new b(a, t.color, !0, this.model(), 'Change ' + n + ' color', t.transparency),
          );
      }),
      (o._createRow_polygons = function (e, t) {
        ...
        $('<td>').append(o).appendTo(i),
          $('<td>').append(n).appendTo(i),
          this.bindControl(new b(n, t.color, !0, this.model(), 'Change ' + o + ' color'));
      }),
      (o._createRow_trendchannels = function (e, t) {
        ...
        $('<td>').append(o).appendTo(i),
          $('<td>').append(n).appendTo(i),
          this.bindControl(
            new b(n, t.color, !0, this.model(), 'Change ' + o + ' color', t.transparency),
          );
      }),
      (o._createRow_textmarks = function (e, t) {
        ...
        $('<td>').append(o).appendTo(i),
          ...
          this.bindControl(
            new b(a, t.fontColor, !0, this.model(), 'Change ' + o + ' text color', t.transparency),
          ),
          this.bindControl(
            new h(r, t.fontSize, parseInt, !0, this.model(), 'Change ' + o + ' font size'),
          ),
          this.bindControl(new h(s, t.fontFamily, null, !0, this.model(), 'Change ' + o + ' font')),
          this.bindControl(new c(l, t.fontBold, !0, this.model(), 'Change Text Font Bold')),
          this.bindControl(new c(p, t.fontItalic, !0, this.model(), 'Change Text Font Italic'));
      }),
      (o._createRow_shapemarks = function (e, t) {
        ...
        s.attr('type', 'text'),
          ...
          this.bindControl(new c(o, t.visible, !0, this.model(), 'Change ' + n + ' visibility')),
          this.bindControl(
            new b(a, t.color, !0, this.model(), 'Change ' + n + ' back color', t.transparency),
          ),
          this.bindControl(new g(s, t.size, null, !1, this.model(), 'Change size'));
      }),
    ...
    inherit(o, s),
      (o.prototype.prepareLayout = function () {
        var e,
          ...
          n,
          a,
          r = $('<table class="property-page" cellspacing="0" cellpadding="0">'),
          l = $('<table class="property-page" cellspacing="0" cellpadding="0">').data({
        ...
        (this._table = r.add(l)),
          ...
          this.bindInteger(i, a.averageHL, $.t('Change Average HL value'), 1, 5e4),
      ...
      (n.prototype.prepareLayout = function () {
        ...
        (this._widget = $('<div>')),
          ...
          (n = this.createColorPicker()),
          (a = this.createColorPicker()),
          (s = $("<input type='checkbox' class='visibility-switch'/>").data('hides', $(n).add(a))),
          (r = $("<input type='checkbox' class='visibility-switch'/>").data('hides', $(o))),
          (l = this.addLabeledRow(e, $.t('Candles'))),
          $('<td>').prependTo(l),
          $('<td>').append(t).appendTo(l),
          $('<td>').append(i).appendTo(l),
          (l = this.addLabeledRow(e, $.t('Borders'), s)),
          $('<td>').append(s).prependTo(l),
          $('<td>').append(n).appendTo(l),
          $('<td>').append(a).appendTo(l),
          $('<td>').appendTo(l),
          (l = this.addLabeledRow(e, $.t('Wick'), r)),
          $('<td>').append(r).prependTo(l),
          $('<td>').append(o).appendTo(l),
          $('<td>').appendTo(l),
          (e = $('<table>').appendTo(this._widget)),
          (l = $('<tr>').appendTo(e)),
          $("<td colspan='2'>").append($.t('Transparency')).appendTo(l),
          (h = d()),
          $("<td colspan='2'>").append(h).appendTo(l),
          (c = this._linetool.properties()),
          this.bindColor(t, c.candleStyle.upColor, 'Change Candle Up Color'),
          this.bindColor(i, c.candleStyle.downColor, 'Change Candle Down Color'),
          this.bindBoolean(r, c.candleStyle.drawWick, 'Change Candle Wick Visibility'),
          this.bindColor(o, c.candleStyle.wickColor, 'Change Candle Wick Color'),
          this.bindBoolean(s, c.candleStyle.drawBorder, 'Change Candle Border Visibility'),
          ...
          this.bindControl(
            new p(h, c.transparency, !0, this.model(), 'Change Guest Feed Transparency'),
          );
      }),
      (n.prototype.widget = function () {
        return this._widget;
    ...
    inherit(o, a),
      (o.prototype.prepareLayout = function () {
        ...
        (this._res = $('<div>')),
          ...
          $('<td colspan="3">').append(t.render().css('display', 'block')).appendTo(o),
          (n = $("<input type='checkbox' class='visibility-switch'>")),
          ...
          $("<td colspan='3'>").append(_).appendTo(o),
          (m = $("<textarea rows='7' cols='60'>").css('width', '100%')),
          (o = $('<tr>').appendTo(this._table)),
          $("<td colspan='7'>").append(m).appendTo(o),
          this.bindControl(
            new l(
              a,
          ...
          this.bindControl(
            new d(m, this._linetool.properties().text, null, !0, this.model(), 'Change Text'),
          ),
          this.bindControl(
            new l(
              n,
          ...
          this.bindControl(
            new p(b, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font'),
          ),
          this.bindControl(
            new h(s, this._linetool.properties().textcolor, !0, this.model(), 'Change Text Color'),
          ),
          this.bindControl(
            new l(y, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold'),
          ),
          this.bindControl(
            new l(
              g,
    ...
    inherit(o, s),
      (o.prototype.prepareLayout = function () {
        ...
        (this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
          ...
          $('<td colspan="2">').append(s).appendTo(a),
          ...
          (y = [d(this._linetool.properties().stopLevel.value()), p(0), l(1e9)]),
          this.bindControl(
            new c(
              o,
          ...
          (y = [d(this._linetool.properties().profitLevel.value()), p(0), l(1e9)]),
          this.bindControl(
            new c(
              u,
      ...
      (n.prototype.prepareLayout = function () {
        ...
        (this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
          ...
          $('<td>').append(w).appendTo(o),
          this.bindControl(
            new u(i, L.linecolor, !0, this.model(), 'Change Risk/Reward line Color'),
          ),
          this.bindControl(
            new b(t, L.linewidth, !0, this.model(), 'Change Risk/Reward line width'),
          ),
          this.bindControl(
            new u(
              n,
          ...
          this.bindControl(
            new y(r, L.fontsize, parseInt, !0, this.model(), 'Change Text Font Size'),
          ),
          this.bindControl(new y(d, L.font, null, !0, this.model(), 'Change Text Font')),
          this.bindControl(new u(s, L.textcolor, !0, this.model(), 'Change Text Color')),
          this.bindControl(new g(_, L.compact, !0, this.model(), 'Compact mode')),
          ...
          this.bindControl(new y(w, L.riskDisplayMode, null, !0, this.model(), '% / Cash')),
          (f = [
            h(L.risk.value()),
            p(1),
            function (e) {
      ...
      (n.prototype._onRiskDisplayModeChange = function () {
        var e = this._linetool,
          ...
          o = e.riskFormatter(i);
        this._riskEdit.data('TVTicker', { step: e.getRiskStep(i), formatter: o.format.bind(o) });
      }),
    ...
    inherit(o, a),
      (o.prototype.prepareLayout = function () {
        ...
        (this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
          ...
          $('<td colspan="3">').appendTo(m).append(C),
          (w = $('<input type="checkbox">')),
          ...
          $('<td colspan="3">').appendTo(n).append(b),
          this.bindControl(
            new c(
              f,
          ...
          this.bindControl(
            new u(l, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font'),
          ),
          this.bindControl(
            new h(s, this._linetool.properties().textcolor, !0, this.model(), 'Change Text Color'),
          ),
          this.bindControl(
            new c(p, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold'),
          ),
          this.bindControl(
            new c(
              d,
      ...
      (n.prototype.prepareLayout = function () {
        ...
        (this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
          ...
          e &&
            ...
            (a = new b(o, this._linetool.properties().angle, n, !1, this.model(), 'Change angle')),
    ...
    inherit(o, n),
      (o.prototype.prepareLayout = function () {
        ...
        (this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
          ...
          (b = $('<label>' + $.t('Extend') + ' </label>').css({ 'margin-left': '8px' })),
          ...
          $('<td colspan="3">').appendTo(n).append(C).append(b),
          (_ = $(
            "<select><option value='" +
              h.Left +
              "'>" +
          ...
          (m = this.addLabeledRow(a, $.t('Stats Position'))),
          $('<td colspan="3">').appendTo(m).append(_),
          (n = this.addLabeledRow(a, $.t('Stats Text Color'))),
          (w = this.createColorPicker()),
          $('<td>').append(w).appendTo(n),
          this.bindControl(
            new r(w, this._linetool.properties().textcolor, !0, this.model(), 'Change Text Color'),
          ),
          (T = $('<input type="checkbox">')),
          (f = $('<input type="checkbox">')),
          (v = $('<input type="checkbox">')),
  ...
  691: function (e, t, i) {
    ...
    i(845),
      ...
      (o.prototype.bindBarIndex = function (e, t, i, n) {
        var a = [l(e.value()), s(o.BarIndexPastLimit), r(o.BarIndexFutureLimit)];
    ...
    (function (e) {
      ...
      inherit(o, p),
        (o.prototype._addSessionEditor = function (e, t, i, o) {
          var n, a, s, r, p, d;
          if ('session' !== i.type)
            return void T.logError('Session editor adding FAILED: wrong input type.');
          (n = function (e, t) {
            var i,
              o = $('<td/>');
            o.appendTo(e),
        ...
        (o.prototype.prepareControl = function (t, i, o) {
            ...
            return function (t) {
              ...
              if (0 === t.indexOf('#')) {
                ...
                if ((o.isStarted() || o.start(null, !0), !(n = o.sourceId())))
                  return void T.logError('Can not get source id for ' + o.metaInfo().id);
                s = t.replace(/^[^\$]+/, n);
              }
              (!~t.indexOf('$') && !~t.indexOf('#')) ||
                E._study.isStarted() ||
          ...
          function a(e) {
            return function (t) {
              var i, o, n, a;
              if (e.hasOwnProperty(t) || 0 === t.indexOf('#') || !~t.indexOf('$')) return t;
              for (
                i = t.slice(0, t.indexOf('$')), o = E._model.model().allStudies(), n = 0;
                n < o.length;
                ++n
              )
          ...
          if ('resolution' === t.type)
              ...
              _(R, {
                onPopupOpen: function (e) {
                  (this._$symbolSearchPopup = e),
                    this._symbolSearchZindex && e.css('z-index', this._symbolSearchZindex);
                }.bind(this),
            ...
            if ((d = this._study && this._study.isChildStudy())) {
              (h = this._study.source()),
                (c = h.title(!0, null, !0)),
                (u = w.getChildSourceInputTitles(t, this._study.source().metaInfo(), c));
              for (b in s) u[b] && (s[b] = 1 === Object.keys(u).length ? c : u[b]);
            }
            if (
                    ...
                    for (p = 0; p < S.length; ++p)
                      (x = S[p]),
                        ~w.CHILD_STUDY_ALLOWED_PLOT_TYPES.indexOf(x.type) &&
                          (s[v + '$' + p] = f + ': ' + ((k && k[x.id] && k[x.id].title) || x.id));
              (F = n(t)), (I = a(s));
            }
            R = $(document.createElement('select'));
            for (P in s) (B = r[P] || s[P]), $('<option>').attr('value', P).text(B).appendTo(R);
            i.addClass('js-value-cell');
          } else if (t.options)
            for (R = $('<select/>'), C = 0; C < t.options.length; C++)
              (P = t.options[C]), $("<option value='" + P + "'>" + P + '</option>').appendTo(R);
          else
            (R = $('<input/>')),
              'bool' === t.type ? R.attr('type', 'checkbox') : R.attr('type', 'text');
          return (
            R &&
              (R.appendTo(i), R.is(':checkbox') || 'symbol' === t.type || R.css('width', '100px')),
        ...
        (o.prototype.prepareLayoutImpl = function (e, t) {
              ...
              'first_visible_bar_time' !== (l = n.id) &&
                ...
                (n.isHidden ||
                  ...
                  (void 0 === n.groupId &&
                    ...
                    n.options
                      ? this.bindControl(
                          new y(L, this._property.inputs[l], null, !0, this.model(), _, k, S),
                        )
                      : 'bar_time' === n.type
                      ? ((x = 10),
                        this.bindControl(
                      ...
                      ? ((P = [c(n.defval)]),
                        ...
                        this.bindControl(
                          new C(L, this._property.inputs[l], P, !1, this.model(), _),
                        ),
                        L.addClass('ticker'),
                        isFinite(n.step) && n.step > 0 && L.attr('data-step', n.step))
                      : 'float' === n.type
                      ? ((P = [u(n.defval)]),
                        (0 === n.min || n.min) && P.push(d(n.min)),
                        (0 === n.max || n.max) && P.push(h(n.max)),
                        (B = new C(L, this._property.inputs[l], P, !1, this.model(), _)),
                        B.addFormatter(i),
                        this.bindControl(B),
                        L.addClass('ticker'),
                        isFinite(n.step) && n.step > 0 && L.attr('data-step', n.step))
                      : 'text' === n.type
                      ? this.bindControl(
                          new C(L, this._property.inputs[l], null, !1, this.model(), _),
                        )
                      : 'bool' === n.type
                      ? this.bindControl(new g(L, this._property.inputs[l], !0, this.model(), _))
                      : 'resolution' === n.type
                      ? this.bindControl(
                          new y(
                            L,
          ...
          this._property.offset &&
            ...
            this.bindControl(
              new C(L, this._property.offset.val, P, !1, this.model(), 'Undo ' + p),
            )),
                ...
                function (e, i) {
                  ...
                  this._property.offsets[i.id] &&
                    ...
                    (void 0 !== o.isHidden && o.isHidden.value()) ||
                      ...
                      a.push(d(o.min)),
                      a.push(h(o.max)),
                      this.bindControl(new C(L, o.val, a, !1, this.model(), 'Undo ' + n))));
                }.bind(this),
              );
        }),
        (o.prototype.prepareLayout = function () {
    ...
    inherit(o, n),
      (o.prototype.addLevelEditor = function (e, t) {
        ...
        return (
          ...
          n.appendTo(o),
          n.css('width', '70px'),
          this.bindControl(new s(n, e.coeff, !1, this.model(), 'Change Pitchfork Line Coeff')),
          (a = $("<td class='colorpicker-cell'>")),
          a.appendTo(d),
          (l = h(a)),
          this.bindControl(
            new r(i, e.visible, !0, this.model(), 'Change Fib Retracement Line Visibility'),
          ),
          this.bindControl(
            new p(l, e.color, !0, this.model(), 'Change Fib Retracement Line Color', 0),
          ),
          d
        );
      }),
      (o.prototype.prepareLayout = function () {
        ...
        for (
          this._div = $(document.createElement('div')).addClass('property-page'),
            ...
            e &&
              ...
              this.bindControl(
                new r(o, e.visible, !0, this.model(), 'Change Fib Retracement Line Visibility'),
              ),
              (n = $("<td class='colorpicker-cell'>").appendTo(i)),
              (a = h(n)),
              this.bindControl(
                new p(a, e.color, !0, this.model(), 'Change Fib Retracement Line Color', 0),
              ),
              (s = $('<td>').appendTo(i)),
              (b = this.createLineWidthEditor()),
              b.appendTo(s),
              this.bindControl(
                new l(b, e.linewidth, parseInt, this.model(), 'Change Fib Retracement Line Width'),
              ),
              (y = $('<td>').appendTo(i)),
              (g = c()),
              g.render().appendTo(y),
            ...
            b.appendTo(s),
            this.bindControl(
              new l(b, C.linewidth, parseInt, this.model(), 'Change Fib Retracement Line Width'),
            ),
            y = $('<td>').appendTo(_),
            g = c(),
            g.render().appendTo(y),
        ...
        this.addOneColorPropertyWidget(this._table),
          ...
          this._linetool.properties().extendRight &&
            ...
            (S = $('<label>').append(P).append($.t('Extend Right'))),
            $('<td>').append(S).appendTo(L)),
          this._linetool.properties().reverse &&
            ((B = $("<input type='checkbox' class='visibility-switch'>")),
            (S = $('<label>').append(B).append($.t('Reverse'))),
            $('<td>').append(S).appendTo(L)),
          (E = $('<tr>').appendTo(v)),
          (R = $("<input type='checkbox' class='visibility-switch'>")),
          (S = $('<label>').append(R).append($.t('Levels'))),
          $('<td>').append(S).appendTo(E),
          (F = $("<input type='checkbox' class='visibility-switch'>")),
          (S = $('<label>').append(F).append($.t('Prices'))),
          $('<td>').append(S).appendTo(E),
          (I = $("<input type='checkbox' class='visibility-switch'>")),
          (S = $('<label>').append(I).append($.t('Percents'))),
          $('<td>').append(S).appendTo(E),
    ...
    (function (t) {
      function o(e, t, i) {
        ...
        r.call(this, a, t),
          ...
          this._series.priceScaleChanged().subscribe(this, this._updateScaleProperties),
      ...
      var n, a, s, r, l, p, d, h, c, u, b, y, g, C, _, m, w, T, f, v, L, k, S, x, P;
      i(11),
        (n = i(1031)),
        (a = i(874)),
        (s = i(823)),
        ...
        (o.prototype.prepareLayout = function () {
          ...
          if (
            (t.enabled('chart_property_page_style') &&
              ...
              (r = $('<table class="property-page" cellspacing="0" cellpadding="2">').data(
                'layout-tab',
                a.TabNames.style,
              )),
              ...
              $('<td>').append(V).prependTo(A),
              $('<td>').css('width', '9px').prependTo(A),
              this.bindControl(
                new c(
                  V,
              ...
              (W = $('<input type="checkbox">')),
              (M = this.addLabeledRow(r, window.t('Show Label on Price Scale'), W)),
              $('<td>').append(W).prependTo(M),
              M.prepend('<td>'),
              this.bindControl(
                new c(
                  W,
            ...
            t.enabled('chart_property_page_scales') &&
              ((q = $('<table class="property-page" cellspacing="0" cellpadding="2">').data(
                'layout-tab',
                a.TabNames.scales,
              )),
              (this._scaleBindings.autoScale = {}),
              (this._scaleBindings.autoScaleDisabled = {}),
              (this._scaleBindings.autoScale.control = $('<input type="checkbox">').change(
                function () {
                  this.checked &&
                    setTimeout(function () {
              ...
              $('<td>').append(this._scaleBindings.autoScale.control).prependTo(U),
              (this._scaleBindings.percentage = {}),
              (this._scaleBindings.percentageDisabled = {}),
              (this._scaleBindings.percentage.control = $('<input type="checkbox">')),
              (Y = this.addLabeledRow(
                q,
                window.t('Percentage'),
                this._scaleBindings.percentage.control,
              )),
              $('<td>').append(this._scaleBindings.percentage.control).prependTo(Y),
              (this._scaleBindings.indexedTo100 = {}),
              (this._scaleBindings.indexedTo100Disabled = {}),
              (this._scaleBindings.indexedTo100.control = $('<input type="checkbox">')),
              (K = this.addLabeledRow(
                q,
                window.t('Indexed to 100'),
                this._scaleBindings.indexedTo100.control,
              )),
              $('<td>').append(this._scaleBindings.indexedTo100.control).prependTo(K),
              (this._scaleBindings.log = {}),
              (this._scaleBindings.logDisabled = {}),
              (this._scaleBindings.log.control = $('<input type="checkbox">')),
              (J = this.addLabeledRow(q, window.t('Log Scale'), this._scaleBindings.log.control)),
              $('<td>').append(this._scaleBindings.log.control).prependTo(J),
              ...
              (this._scaleBindings.lockScale.control = $("<input type='checkbox'/>")),
              (X = this.addLabeledRow(
                q,
                window.t('Lock Scale'),
                this._scaleBindings.lockScale.control,
              )),
              $('<td>').append(this._scaleBindings.lockScale.control).prependTo(X),
              (ee = function (e) {
              ...
              t.enabled('support_multicharts') &&
                ...
                $('<td>').append(te).prependTo(ie),
                this.bindControl(
                  new C(te, this._model.trackTime(), null, this.model(), 'Change track time'),
                )),
              (oe = $('<table class="property-page" cellspacing="0" cellpadding="2">').data(
                'layout-tab',
                a.TabNames.scales,
              )),
              (ne = $('<input type="text" class="ticker ticker--longer-sign_8">')),
              ...
              (re = $('<input type="text" class="ticker ticker--longer-sign_8">')),
              (le = this.addLabeledRow(oe, window.t('Bottom Margin'), re)),
              $('<td>').appendTo(le).append(re),
              $('<td>%</td>').appendTo(le),
              ...
              $('<td>' + window.t('bars', { context: 'margin' }) + '</td>').appendTo(he),
              (ce = this._chart.timeScale()),
              (ue = [d(ce.defaultRightOffsetProperty().value())]),
              ue.push(p(~~ce.maxRightOffset())),
              ue.push(l(0)),
              this.bindControl(
                new h(de, ce.defaultRightOffsetProperty(), ue, !0, this.model(), 'Right Margin'),
              ),
              (be = $('<input type="text" class="ticker ticker--longer-sign_8">')),
              (he = this.addLabeledRow(oe, window.t('Price/Bar Ratio'), be)),
              (ye = !0),
              (ge = function (e) {
                this._undoModel.setScaleRatioProperty(this._property, e, this._undoText),
                  ye && (x('GUI', 'Scales', 'Edit scale ratio value'), (ye = !1));
              }),
              $('<td>').appendTo(he).append(be),
              be.TVTicker({ step: this._mainSeriesScaleRatioProperty.getStepChangeValue() }),
              (Ce = m('', 7)),
              (_e = [
                _(
                  this._mainSeriesScaleRatioProperty.value.bind(this._mainSeriesScaleRatioProperty),
                ),
              ...
              $e.addFormatter(Ce),
              this.bindControl($e),
              (me = $('<table class="property-page" cellspacing="0" cellpadding="2">').data(
                'layout-tab',
                a.TabNames.scales,
              )),
              ...
              (xe = this.addLabeledRow(me, window.t('Indicator Last Value'), Se)),
              $('<td>').append(Se).prependTo(xe),
              this.bindControl(
                new c(
                  Se,
              ...
              (this._scaleBindings.alignLabels.control = $("<input type='checkbox' />")),
              (Fe = this.addLabeledRow(
                me,
                window.t('No Overlapping Labels'),
                this._scaleBindings.alignLabels.control,
              )),
              $('<td>').append(this._scaleBindings.alignLabels.control).prependTo(Fe),
              this._bindScaleProperties(),
              (Ie = $('<div class="property-page-column-2">').append(q).append(oe)),
              (De = $('<div class="property-page-column-2">').append(me)),
              (B = $('<div>').css('min-width', '520px').data('layout-tab', a.TabNames.scales)),
              B.append(Ie).append(De),
              (this.scalesTab = B),
              (g = $('<table class="property-page" cellspacing="0" cellpadding="2">').data(
                'layout-tab',
                a.TabNames.style,
              )),
            ...
            t.enabled('chart_property_page_background') &&
              ((Oe = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
              (ze = this.createColorPicker({ hideTransparency: !0 })),
              (He = this.addLabeledRow(Oe, window.t('Background'))),
              $('<td colspan="2">').append(ze).appendTo(He),
              this.bindControl(
                new b(
                  ze,
              ...
              (je = v()),
              $('<td colspan="2">').append(je.render()).appendTo(Ne),
              this.bindControl(
                new y(
                  je,
              ...
              (Ye = v()),
              $('<td colspan="2">').append(Ye.render()).appendTo(qe),
              this.bindControl(
                new y(
                  Ye,
              ...
              $('<td colspan="2">').append(Qe).appendTo(Xe),
              this.bindControl(
                new b(
                  Qe,
              ...
              (nt = v()),
              $('<td>').append(nt.render()).appendTo(it),
              this.bindControl(
                new y(
                  nt,
              ...
              $('<td>').append(at).appendTo(this.addRow(Oe).prepend('<td/><td/>')),
              this.bindControl(
                new u(
                  at,
              ...
              (rt = this.addLabeledRow(st, window.t('Navigation Buttons'), null, !0)),
              ...
              (pt = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
              ...
              P &&
                ...
                (yt = this.addLabeledRow(pt, window.t('Show Chart Source Value Only'), bt)),
                $('<td>').append(bt).prependTo(yt),
                this.bindControl(
                  new c(
                    bt,
              ...
              (wt = this.addLabeledRow(pt, window.t('Indicator Arguments'), mt)),
              (Tt = function (e) {
                mt.prop('disabled', !e.value());
              }),
              $('<td>').append(mt).prependTo(wt),
              this.bindControl(
                new c(
                  mt,
              ...
              this._property.paneProperties.legendProperties.showStudyTitles
                .listeners()
                .subscribe(this, Tt),
              Tt(this._property.paneProperties.legendProperties.showStudyTitles),
              (ft = $('<input type="checkbox">')),
              (vt = this.addLabeledRow(pt, window.t('Indicator Values'), ft)),
              $('<td>').append(ft).prependTo(vt),
              this.bindControl(
                new c(
                  ft,
              ...
              (E = $('<div>').css('min-width', '520px').data('layout-tab', a.TabNames.background)),
              E.append(Lt).append(kt).append(St)),
            ...
            for (
              ...
              Ft += '<option value="' + k[It].id + '">' + k[It].title + '</option>';
            (Dt = $('<select>' + Ft + '</select>')),
              Dt.appendTo(Rt),
              this.bindControl(
                new y(Dt, this._property.timezone, null, !0, this.model(), 'Change Timezone'),
              ),
              this._series.createSessStudy(),
              this.createSessTable(F);
          }
          (Vt = t.enabled('trading_options') || t.enabled('chart_property_page_trading')),
        ...
        (o.prototype._bindScaleProperties = function () {
          var e,
            ...
            s = function (t) {
              (e = { autoScale: t }),
                this._undoModel.setPriceScaleMode(e, a._series.priceScale(), this._undoText);
            };
        ...
        (o.prototype.createScaleNameList = function (e, t, i) {
          ...
          for (
            o = this._pane.actionNoScaleIsEnabled(t), n = e.getValues(o), a = {}, s = 0;
            s < n.length;
            s++
          )
            a[n[s]] = i[n[s]];
        ...
        (o.prototype.applyTheme = function (e, t) {
          this._model.chartWidget().chartWidgetCollection().applyTheme(e, t), this.loadData();
        }),
        ...
        (o.prototype.createApplyToAllButton = function (e) {
          var t = $('<a class="_tv-button ok">' + window.t('Apply To All') + '</a>');
        ...
        (o.prototype.defaultProperties = function () {
          ...
          return (
            setTimeout(function () {
              ...
              var i = new L('chartproperties.paneProperties.rightAxisProperties');
              ['autoScale', 'percentage', 'log', 'indexedTo100'].forEach(function (t) {
        ...
        (o.prototype.createSessTable = function (e) {
          var t,
            ...
            p = this.createLineWidthEditor();
          return (
            $('<td>').append(a).prependTo(s),
            $('<td>').append(l).appendTo(s),
            $('<td>').append(r.render()).appendTo(s),
            $('<td>').append(p).appendTo(s),
            this.bindControl(
              new c(
                a,
        ...
        (o.prototype._createStudySessRow = function (e, t, i) {
          var o,
            ...
            s = f($('<td>').appendTo(a));
          return (
            this.bindControl(new c(n, i.visible, !0, this.model(), 'Change ' + t + ' visibility')),
            this.bindControl(new b(s, i.color, !0, this.model(), t + ' color', i.transparency)),
            (o = $('<td>')),
        ...
        (o.prototype.createTradingTable = function () {
          var e,
            ...
            C,
            _,
            m = $('<table class="property-page" cellspacing="0" cellpadding="2">').data(
              'layout-tab',
              a.TabNames.trading,
            ),
            w = $('<tr>').appendTo(m),
          ...
          return (
            ...
            (s = $('<input type="text" class="ticker">')),
            (r = [d(this._property.tradingProperties.lineLength.value()), p(100), l(0)]),
            this.bindControl(
              new h(
                s,
            ...
            $('<td colspan="3">').append(s).appendTo(g),
            $('<td>%</td>').appendTo(g),
            (C = $('<input type="checkbox">')),
            (_ = this.addLabeledRow(f, window.t('Show Executions'), C)),
            $('<td>').append(C).prependTo(_),
            this.bindControl(
              new c(
                C,
    ...
    inherit(o, n),
      (o.prototype.prepareLayout = function () {
        ...
        (this._table = $(document.createElement('table'))),
          ...
          this.bindControl(
            new l(d, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font'),
          ),
          this.bindControl(
            new p(o, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold'),
          ),
          this.bindControl(
            new p(
              n,
          ...
          (c = $('<table class="property-page" cellspacing="0" cellpadding="2"><tr>')
            .append($(document.createElement('td')).attr({ width: 1 }).append(i))
            .append($(document.createElement('td')).attr({ width: 1 }).append(d))
            .append($(document.createElement('td')).attr({ width: 1 }).append(a))
            .append(
            ...
            .append($(document.createElement('td')).css('vertical-align', 'top').append(n))
            .append($('</tr></table>'))),
    ...
    inherit(o, n),
      (o.prototype.prepareLayout = function () {
        ...
        (this._table = $(document.createElement('table'))),
          ...
          this.bindControl(
            new r(t, this._linetool.properties().color, !0, this.model(), 'Change Arc Line Color'),
          ),
          this.bindControl(
            new r(
              n,
  ...
  707: function (e, t, i) {
    ...
    inherit(o, n),
      (o.prototype.prepareLayout = function () {
        var e, t, i, o, n;
        (this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">').css({
          width: '100%',
        })),
    ...
    inherit(o, n),
      (o.prototype.prepareLayout = function () {
        var e,
          ...
          u = $('<table class="property-page" cellspacing="0" cellpadding="0">');
        (this._table = c.add(u)),
          (e = $("<input type='text'>").css({ width: '100%' })),
          (t = this.createColorPicker()),
    ...
    inherit(o, a),
      ...
      (n.prototype.prepareLayout = function () {
        ...
        (this._table = $(document.createElement('table'))),
          ...
          (p = [l(r.price.value())]),
          this.bindControl(
            new c(o, r.price, p, !1, this.model(), 'Change ' + this._linetool + ' point price'),
          ),
          this.bindBarIndex(
            r.bar,
            s,
    ...
    inherit(o, n),
      (o.prototype.prepareLayout = function () {
        ...
        (this._block = $('<div>').addClass('property-page')),
          ...
          (h = $('<table cellspacing="0" cellpadding="2">').appendTo(this._block)),
          (a = this.addLabeledRow(h, $.t('Background'), c)),
          (c = $('<input type="checkbox" class="visibility-switch">')),
          (u = this.createColorPicker()),
          $('<td>').append(c).prependTo(a),
          $('<td>').append(u).appendTo(a),
          (b = $('<table cellspacing="0" cellpadding="2">').appendTo(this._block)),
          (y = $(
            "<select><option value='0'>" +
              $.t('Normal') +
              "</option><option value='1'>" +
          ...
          $('<td colspan="3">').appendTo(a).append(y).append(C),
          (a = this.addLabeledRow(b, $.t('Right End'))),
          $('<td colspan="3">').appendTo(a).append(g).append(m),
          this.bindControl(
            new s(
              n,
              this._linetool.properties().linecolor,
    ...
    inherit(o, n),
      (o.prototype.prepareLayout = function () {
        ...
        (this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
          ...
          this.bindControl(
            new l(t, this._linetool.properties().linecolor, !0, this.model(), 'Change Brush Color'),
          ),
          this.bindControl(
            new s(
              e,
  ...
  712: function (e, t, i) {
    ...
    inherit(o, n),
      (o.prototype.prepareLayout = function () {
        ...
        this.bindControl(
          new r(n, this._linetool.properties().color, !0, this.model(), 'Change Text Color'),
        ),
          this.bindControl(
            new l(
              a,
          ...
          this.bindControl(
            new l(c, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font'),
          ),
          this.bindControl(
            new d(u, this._linetool.properties().text, null, !0, this.model(), 'Change Text'),
          ),
          this.bindControl(
            new r(
              b,
          ...
          this.bindControl(
            new s(C, this._linetool.properties().wordWrap, !0, this.model(), 'Change Text Wrap'),
          ),
          this.bindControl(
            new s(_, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold'),
          ),
          this.bindControl(
            new s(
              m,
          ...
          (i = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
          (this._table = e.add(i).add(t)),
          $(document.createElement('tr'))
            .append($(document.createElement('td')).attr({ width: 1 }).append(n))
            .append($(document.createElement('td')).attr({ width: 1 }).append(c))
            .append($(document.createElement('td')).attr({ width: 1 }).append(a))
            .append($(document.createElement('td')).attr({ width: 1 }).append(_))
            .append($(document.createElement('td')).append(m))
            .appendTo(e),
          $(document.createElement('tr'))
            .append($(document.createElement('td')).attr({ colspan: 5 }).append(u))
            .appendTo(e),
    ...
    inherit(o, n),
      (o.prototype.prepareLayout = function () {
        ...
        (this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
          ...
          this.bindControl(
            new r(n, this._linetool.properties().textcolor, !0, this.model(), 'Change Text Color'),
          ),
          this.bindControl(
            new s(
              d,
          ...
          this.bindControl(
            new s(h, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font'),
          ),
          this.bindControl(
            new r(
              c,
  ...
  716: function (e, t, i) {
    ...
    inherit(o, n),
      (o.prototype.prepareLayout = function () {
        var e, t, i, o, n, a, h, c, u, b, y, g, C, _, m, w, T, f, v, L, k, S, x, P;
        (this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
          (e = $('<tbody>').appendTo(this._table)),
          (t = this.createLineWidthEditor()),
          (i = d()),
          ...
          (_ = $('<table>')),
          $('<td colspan="5">').append(_).appendTo(n),
          (n = $('<tr>').appendTo(_)),
          ...
          (f = $('<label>' + $.t('Extend') + ' </label>').css({ 'margin-left': '8px' })),
          ...
          $('<td colspan="3">').appendTo(n).append(L).append(w),
          (n = this.addLabeledRow(m, $.t('Right End'))),
          $('<td colspan="3">').appendTo(n).append(k).append(f),
          (S = $('<tbody>').appendTo(this._table)),
          (n = $('<tr>').appendTo(S)),
          (x = $("<input type='checkbox'>")),
          (P = $("<label style='display:block'>").append(x).append($.t('Show Prices'))),
          $("<td colspan='2'>").append(P).appendTo(n),
          this.bindControl(
            new s(
              h,
              this._linetool.properties().fontsize,
          ...
          this.bindControl(
            new s(c, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font'),
          ),
          this.bindControl(
            new l(a, this._linetool.properties().textcolor, !0, this.model(), 'Change Text Color'),
          ),
          this.bindControl(
            new r(u, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold'),
          ),
          this.bindControl(
            new r(
              b,
        ...
        w.appendTo(this._table),
          ...
          e
            ? ((a = $('<td>')),
              ...
              u.appendTo(a),
              u.css('width', '70px'),
              this.bindControl(new s(u, t.coeff, !1, this.model(), 'Change Pitchfork Line Coeff')))
          ...
          e ||
            ...
            m.render().appendTo(_),
            this.bindControl(
              new r(m, t.linestyle, parseInt, !0, this.model(), 'Change Fib Circle Style'),
            )),
          this.bindControl(new l(n, t.visible, !0, this.model(), 'Change Fib Circle Visibility')),
          this.bindControl(new p(y, t.color, !0, this.model(), 'Change Fib Circle Line Color', 0)),
          this.bindControl(new d(C, t.linewidth, !0, this.model(), 'Change Fib Circle Width'));
      }),
      (o.prototype.prepareLayout = function () {
        var e, t, i, o, n, a, s;
        for (
        ...
        this.addOneColorPropertyWidget(this._table),
          ...
          (s = u()),
          $('<td colspan="3">').append(s).appendTo(o),
          this.bindControl(
            new l(
              a,
              this._linetool.properties().fillBackground,
    ...
    inherit(o, n),
      (o.prototype.addLevelEditor = function (e, t, i) {
        ...
        w.appendTo(this._table),
          ...
          this.bindControl(
            new l(n, t.visible, !0, this.model(), 'Change Fib Speed Resistance Arcs Visibility'),
          ),
          this.bindControl(
            new p(y, t.color, !0, this.model(), 'Change Fib Speed Resistance Arcs Line Color', 0),
          ),
          this.bindControl(
            new d(C, t.linewidth, !0, this.model(), 'Change Fib Speed Resistance Arcs Width'),
          );
      }),
      (o.prototype.prepareLayout = function () {
        var e, t, i, o, n, a, s;
    ...
    inherit(o, n),
      (o.prototype.addLevelEditor = function (e, t, i) {
        ...
        u.appendTo(e),
          ...
          p.css('width', '70px'),
          this.bindControl(
            new s(n, i.visible, !0, this.model(), 'Change Gann Square Line Visibility'),
          ),
          this.bindControl(new l(p, i.coeff, !1, this.model(), 'Change Pitchfork Line Coeff')),
          (d = $("<td class='colorpicker-cell'>")),
          d.appendTo(u),
          (c = h(d)),
          this.bindControl(new r(c, i.color, !0, this.model(), 'Change Gann Square Line Color', 0));
      }),
      (o.prototype.prepareLayout = function () {
        ...
        for (
          this._table = $(document.createElement('table')),
            ...
            $("<tr><td align='center' colspan='4'>" + $.t('Price Levels') + '</td></tr>').appendTo(
              n,
            ),
            $("<tr><td align='center' colspan='4'>" + $.t('Time Levels') + '</td></tr>').appendTo(
              a,
            ),
            l = 1;
          l <= 7;
          ...
          (h = 'hlevel' + l), this.addLevelEditor(n, 'Level ' + l, this._linetool.properties()[h]);
        for (l = 1; l <= 7; l++)
          (h = 'vlevel' + l), this.addLevelEditor(a, 'Level ' + l, this._linetool.properties()[h]);
        this.addOneColorPropertyWidget(n),
          ...
          $('<td>').append(S).appendTo(f),
          $('<td>').append(L).appendTo(f),
          $('<td>').append(k.render()).appendTo(f),
          this.bindControl(
            new s(
              x,
          ...
          (P = u()),
          $('<td colspan="3">').append(P).appendTo(f),
          this.bindControl(
            new s(
              x,
              this._linetool.properties().fillBackground,
    ...
    inherit(o, n),
      (o.prototype.prepareLayout = function () {
        ...
        (this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
          ...
          (a = $('<input type="checkbox">')),
          (h = this.addLabeledRow(this._table, window.t('Counterclockwise'), a)),
    ...
    inherit(o, n),
      (o.prototype.addLevelEditor = function (e, t, i) {
        ...
        w.appendTo(this._table),
          ...
          m.render().appendTo(_),
          this.bindControl(
            new r(n, t.visible, !0, this.model(), 'Change Pitchfork Line Visibility'),
          ),
          this.bindControl(new l(y, t.color, !0, this.model(), 'Change Pitchfork Line Color', 0)),
          this.bindControl(
            new p(m, t.linestyle, parseInt, !0, this.model(), 'Change Pitchfork Line Style'),
          ),
          this.bindControl(
            new d(C, t.linewidth, parseInt, this.model(), 'Change Pitchfork Line Width'),
          );
      }),
      (o.prototype.prepareLayout = function () {
        ...
        g.appendTo(this._table),
          ...
          e
            ? ((a = $('<td>')),
              ...
              h.appendTo(a),
              h.css('width', '70px'),
              this.bindControl(new s(h, t.coeff, !1, this.model(), 'Change Pitchfork Line Coeff')))
          ...
          (y = this.createLineWidthEditor()),
          y.appendTo(b),
          this.bindControl(new r(n, t.visible, !0, this.model(), 'Change Fib Wedge Visibility')),
          this.bindControl(new l(u, t.color, !0, this.model(), 'Change Fib Wedge Line Color', 0)),
          this.bindControl(new p(y, t.linewidth, !0, this.model(), 'Change Fib Wedge Width'));
      }),
      (o.prototype.prepareLayout = function () {
        var e, t, i, o, n, a;
        for (
    ...
    inherit(o, n),
      (o.prototype.prepareLayout = function () {
        ...
        (this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
          ...
          this.bindControl(
            new r(a, this._linetool.properties().textcolor, !0, this.model(), 'Change Text Color'),
          ),
          this.bindControl(
            new l(u, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold'),
          ),
          this.bindControl(
            new l(
              b,
    ...
    i(845),
      ...
      (o.prototype.addOneColorPropertyWidget = function (e) {
        var t = this.createOneColorForAllLinesWidget(),
          i = $('<tr>');
        i.append($('<td>')).append($('<td>')).append(t.editor).append($('<td>').append(t.label)),
          i.appendTo(e);
      }),
      (o.prototype.prepareLayout = function () {
        var e,
        ...
        for (g in o.levels._childs)
          (C = o.levels[g]),
            ...
            v.appendTo(f),
            this.bindControl(new p(m, C.visible, !0, t, 'Change Gann Line Visibility')),
            this.bindControl(new h(T, C.color, !0, t, 'Change Gann Line Color', 0)),
            this.bindControl(new d(v, C.width, !0, t, 'Change Gann Line Width'));
        (L = $('<table>')),
        ...
        for (g in o.fanlines._childs)
          (S = o.fanlines[g]),
            ...
            (v = this.createLineWidthEditor()),
            v.appendTo(f),
            this.bindControl(new p(m, S.visible, !0, t, 'Change Gann Line Visibility')),
            this.bindControl(new h(T, S.color, !0, t, 'Change Gann Fan Color', 0)),
            this.bindControl(new d(v, S.width, !0, t, 'Change Gann Line Width'));
        (B = $('<table>')),
          $("<td valign='top'>").append(B).appendTo(e),
          (E = $('<tr>')),
        ...
        for (g in o.arcs._childs)
          (R = o.arcs[g]),
            ...
            (v = this.createLineWidthEditor()),
            v.appendTo(f),
            this.bindControl(new p(m, R.visible, !0, t, 'Change Gann Line Visibility')),
            this.bindControl(new h(T, R.color, !0, t, 'Change Gann Arc Color', 0)),
            this.bindControl(new d(v, R.width, !0, t, 'Change Gann Line Width'));
        this.addOneColorPropertyWidget(B),
          ...
          (A = $('<tr>').appendTo(I)),
          (W = $('<table>')),
          $('<td colspan="3">').append(W).appendTo(A),
          (A = $('<tr>').appendTo(W)),
          $('<td>').append(D).appendTo(A),
          $('<td>' + $.t('Background') + '</td>').appendTo(A),
          $('<td>').append(V).appendTo(A),
          o.reverse &&
            ((M = $("<input type='checkbox' class='visibility-switch'>")),
            (A = this.addLabeledRow(W, $.t('Reverse'), M, !0)),
            $('<td>').append(M).prependTo(A),
            (O = 'Change Gann Square Reverse'),
            this.bindControl(new p(M, o.reverse, !0, t, O))),
          this.bindControl(
            new p(D, o.arcsBackground.fillBackground, !0, t, 'Change Gann Square Filling'),
          ),
          this.bindControl(
            new d(
              V,
          ...
          $('<td>').append(j).prependTo(A),
          this.bindControl(new p(j, o.showLabels, !0, t, 'Change Gann Square Lables Visibility')),
          (v = this.createLineWidthEditor()),
          (T = this.createColorPicker()),
          (q = $(
            '<span class="_tv-button _tv-button-fontstyle"><span class="icon-fontstyle-bold"></span></span>',
          ...
          (J = o.labelsStyle),
          this.bindControl(new c(Y, J.fontSize, parseInt, !0, t, 'Change Text Font Size')),
          this.bindControl(new c(K, J.font, null, !0, t, 'Change Text Font')),
          this.bindControl(new p(q, J.bold, !0, t, 'Change Text Font Bold')),
          this.bindControl(new p(U, J.italic, !0, t, 'Change Text Font Italic')),
          (Z = $('<table class="property-page" cellspacing="0" cellpadding="2"><tr>')
            .append($(document.createElement('td')).attr({ width: 1 }).append(K))
            .append($(document.createElement('td')).attr({ width: 1 }).append(Y))
            .append(
              $(document.createElement('td'))
                .css('vertical-align', 'top')
                .attr({ width: 1 })
            ...
            .append($(document.createElement('td')).css('vertical-align', 'top').append(U))
            .append($('</tr></table>'))),
          $('<td colspan="5" class="no-left-indent">').append(Z).appendTo(A);
      }),
      (o.prototype.widget = function () {
        return this._table;
      }),
  ...
  728: function (e, t, i) {
    ...
    inherit(o, n),
      ...
      (o.prototype.prepareLayout = function () {
        var e, t, i, o, n, a, h, c, u, b, y, g, C, _, m, w, T, f, v, L, k, S, x, P, B, E, R;
        (this._table = $(document.createElement('table'))),
          this._table.addClass('property-page property-page-unpadded'),
          this._table.attr('cellspacing', '0'),
          this._table.attr('cellpadding', '2'),
        ...
        for (n in t.levels._childs)
          (a = t.levels[n]),
            ...
            g.appendTo(y),
            this.bindControl(new s(c, a.visible, !0, this.model(), 'Change Gann Line Visibility')),
            this.bindControl(new l(b, a.color, !0, this.model(), 'Change Gann Line Color', 0)),
            this.bindControl(new r(g, a.width, !0, this.model(), 'Change Gann Line Width'));
        (C = $('<table>')),
          $("<td valign='top'>").append(C).appendTo(e),
          (_ = $('<tr>')),
        ...
        for (n in t.fanlines._childs)
          (m = t.fanlines[n]),
            ...
            (g = this.createLineWidthEditor()),
            g.appendTo(y),
            this.bindControl(new s(c, m.visible, !0, this.model(), 'Change Gann Line Visibility')),
            this.bindControl(new l(b, m.color, !0, this.model(), 'Change Gann Fan Color', 0)),
            this.bindControl(new r(g, m.width, !0, this.model(), 'Change Gann Line Width'));
        (f = $('<table>')),
        ...
        for (n in t.arcs._childs)
          (L = t.arcs[n]),
            ...
            (g = this.createLineWidthEditor()),
            g.appendTo(y),
            this.bindControl(new s(c, L.visible, !0, this.model(), 'Change Gann Line Visibility')),
            this.bindControl(new l(b, L.color, !0, this.model(), 'Change Gann Arc Color', 0)),
            this.bindControl(new r(g, L.width, !0, this.model(), 'Change Gann Line Width'));
        this.addOneColorPropertyWidget(f),
          ...
          (B = $('<tr>').appendTo(S)),
          (E = $('<table>')),
          $('<td colspan="3">').append(E).appendTo(B),
          (B = $('<tr>').appendTo(E)),
          $('<td>').append(x).appendTo(B),
          $('<td>' + $.t('Background') + '</td>').appendTo(B),
          $('<td>').append(P).appendTo(B),
          t.reverse &&
            ((R = $("<input type='checkbox' class='visibility-switch'>")),
            (B = this.addLabeledRow(E, $.t('Reverse'), R, !0)),
            $('<td>').append(R).prependTo(B),
            this.bindControl(new s(R, t.reverse, !0, this.model(), 'Change Gann Square Reverse'))),
          this.bindControl(
            new s(
              x,
    ...
    inherit(o, n),
      (o.prototype.addLevelEditor = function (e, t, i, o) {
        ...
        w.appendTo(this._tbody),
          ...
          (a = $('<td>')),
          a.appendTo(w),
          (c = $("<input type='checkbox' class='visibility-switch' id='" + n + "'>")),
          c.appendTo(a),
          ...
          m.render().appendTo(_),
          this.bindControl(
            new s(c, t.visible, !0, this.model(), 'Change Gann Fan Line Visibility'),
          ),
          this.bindControl(new r(y, t.color, !0, this.model(), 'Change Gann Fan Line Color', 0)),
          this.bindControl(
            new l(m, t.linestyle, parseInt, !0, this.model(), 'Change Gann Fan Line Style'),
          ),
          this.bindControl(new p(C, t.linewidth, !0, this.model(), 'Change Gann Fan Line Width'));
      }),
      (o.prototype.prepareLayout = function () {
        var e,
          t,
          ...
          b = $('<table class="property-page" cellspacing="0" cellpadding="2">');
        ...
        this.addOneColorPropertyWidget(this._tbody),
          ...
          (d = $("<input type='checkbox' class='visibility-switch'>")),
          $('<td>').append(d).appendTo(l),
          this.createLabeledCell($.t('Background'), d).appendTo(l),
          (h = c()),
          $('<td colspan="3">').append(h).appendTo(l),
          this.bindControl(
            new s(
              d,
              this._linetool.properties().fillBackground,
    ...
    inherit(o, n),
      (o.prototype.addLevelEditor = function (e, t, i) {
        ...
        u.appendTo(e),
          ...
          this.bindControl(new r(p, i.coeff, !1, this.model(), 'Change Pitchfork Line Coeff')),
          (h = $("<td class='colorpicker-cell'>")),
          h.appendTo(u),
          (c = d(h)),
          this.bindControl(new l(c, i.color, !0, this.model(), 'Change Gann Square Line Color', 0));
      }),
      ...
      (o.prototype.prepareLayout = function () {
        ...
        for (
          ...
          (l = 'hlevel' + r),
            this.addLevelEditor(n, $.t('Level {0}').format(r), this._linetool.properties()[l]);
        for (r = 1; r <= 7; r++)
          (l = 'vlevel' + r),
            this.addLevelEditor(a, $.t('Level {0}').format(r), this._linetool.properties()[l]);
        this.addFannEditor(n),
          ...
          (g = $('<tr>').appendTo(y)),
          (C = $('<table class="property-page" cellspacing="0" cellpadding="0">').appendTo(
            $('<td>').css({ width: '50%', 'vertical-align': 'top' }).appendTo(g),
          )),
          (_ = $('<table class="property-page" cellspacing="0" cellpadding="0">').appendTo(
            $('<td>').css({ width: '50%', 'vertical-align': 'top' }).appendTo(g),
          )),
          (m = this.addLabeledRow(C, $.t('Left Labels'), d)),
          $('<td>').append(d).prependTo(m),
    ...
    inherit(o, n),
      (o.prototype.prepareLayout = function () {
        ...
        (this._table = $(document.createElement('table'))),
          ...
          this.bindControl(new a(e, o.color, !0, this.model(), 'Change Icon Color')),
          this.loadData();
      }),
      (o.prototype.widget = function () {
        return this._div;
    ...
    inherit(o, n),
      (o.prototype.prepareLayout = function () {
        ...
        (this._table = $(document.createElement('table'))),
          ...
          this.bindControl(
            new p(d, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font'),
          ),
          this.bindControl(
            new s(o, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold'),
          ),
          this.bindControl(
            new s(
              n,
          ...
          (b = $('<table class="property-page" cellspacing="0" cellpadding="2"><tr>')
            ...
            .append($('</tr></table>'))),
          (h = this.addLabeledRow(this._table, '')),
          $('<td colspan="5">').append(b).appendTo(h),
          this.loadData();
      }),
      (o.prototype.widget = function () {
        return this._table;
    ...
    inherit(o, a),
      (o.prototype.prepareLayout = function () {
        ...
        this.bindControl(
          ...
          this.bindControl(
            new l(s, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font'),
          ),
          this.bindControl(
            new p(h, this._linetool.properties().text, null, !0, this.model(), 'Change Text'),
          ),
          this.bindControl(
            new r(
              c,
          ...
          this.bindControl(
            new d(b, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold'),
          ),
          this.bindControl(
            new d(
              y,
          ...
          $(document.createElement('tr'))
            .append($(document.createElement('td')).attr({ width: 1 }).append(n))
            .append($(document.createElement('td')).attr({ width: 1 }).append(s))
            .append($(document.createElement('td')).attr({ width: 1 }).append(a))
            .append($(document.createElement('td')).attr({ width: 1 }).append(b))
            .append($(document.createElement('td')).append(y))
            .appendTo(e),
          $(document.createElement('tr'))
            .append($(document.createElement('td')).attr({ colspan: 5 }).append(h))
            .appendTo(e),
      ...
      (o.prototype.dialogPosition = function (e, t) {
        ...
        if (e && t) {
          for (
            i = 0, o = this._linetool._model.paneForSource(this._linetool), a = h.getChartWidget();
    ...
    inherit(o, n),
      (o.prototype.prepareLayout = function () {
        ...
        (this._table = $(document.createElement('table'))),
          ...
          (m = this.addEditorRow(_, 'Extend Left', $("<input type='checkbox'>"), 2)),
          (w = this.addEditorRow(_, 'Extend Right', $("<input type='checkbox'>"), 2)),
          (T = this._linetool.properties()),
          this.bindControl(
            new s(g, T.fillBackground, !0, this.model(), 'Change Parallel Channel Fill Background'),
          ),
          this.bindControl(
            new s(h, T.showMidline, !0, this.model(), 'Change Parallel Channel Show Center Line'),
          ),
          this.bindControl(
            new s(m, T.extendLeft, !0, this.model(), 'Change Parallel Channel Extending Left'),
          ),
          this.bindControl(
            new s(w, T.extendRight, !0, this.model(), 'Change Parallel Channel Extending Right'),
          ),
          this.bindControl(
            new r(o, T.linecolor, !0, this.model(), 'Change Parallel Channel Color'),
          ),
          this.bindControl(
            new l(i, T.linestyle, parseInt, !0, this.model(), 'Change Parallel Channel Style'),
          ),
          this.bindControl(
            new p(t, T.linewidth, !0, this.model(), 'Change Parallel Channel Width'),
          ),
          this.bindControl(
            new r(b, T.midlinecolor, !0, this.model(), 'Change Parallel Channel Middle Color'),
          ),
          this.bindControl(
            new l(
              u,
          ...
          this.bindControl(
            new p(c, T.midlinewidth, !0, this.model(), 'Change Parallel Channel Middle Width'),
          ),
          this.bindControl(
            new r(
              C,
        ...
        w.appendTo(this._table),
          e
            ? ((o = $('<td>')),
              ...
              u.css('width', '70px'),
              this.bindControl(
                new s(n, t.visible, !0, this.model(), 'Change Pitchfork Line Visibility'),
              ),
          ...
          this.bindControl(new l(y, t.color, !0, this.model(), 'Change Pitchfork Line Color'), 0),
          this.bindControl(
            new p(m, t.linestyle, parseInt, !0, this.model(), 'Change Pitchfan Line Style'),
          ),
          this.bindControl(new d(C, t.linewidth, !0, this.model(), 'Change Pitchfan Line Width'));
      }),
      (o.prototype.prepareLayout = function () {
        var e, t, i, o, n;
        for (
          ...
          (t = 'level' + e),
            this.addLevelEditor($.t('Level {0}').format(e + 1), this._linetool.properties()[t], !1);
        this.addOneColorPropertyWidget(this._table),
          (i = $('<tr>')),
          i.appendTo(this._table),
          (o = $("<input type='checkbox' class='visibility-switch'>")),
        ...
        w.appendTo(this._table),
          e
            ? ((o = $('<td>')),
              ...
              this.bindControl(new r(u, t.coeff, !1, this.model(), 'Change Pitchfork Line Coeff')))
            : ($('<td></td>').appendTo(w), $('<td>' + $.t('Median') + '</td>').appendTo(w)),
          (b = $("<td class='colorpicker-cell'>")),
          b.appendTo(w),
          (y = h(b)),
          (g = $('<td>')),
          ...
          this.bindControl(new d(C, t.linewidth, !0, this.model(), 'Change Pitchfork Line Width'));
      }),
      (o.prototype.prepareLayout = function () {
        var e, t, i, o, n, a;
        for (
    ...
    inherit(o, n),
      (o.prototype.prepareLayout = function () {
        var e,
          ...
          _,
          m,
          w = $('<table class="property-page" cellspacing="0" cellpadding="2">'),
          T = $(
            '<table class="property-page property-page-unpadded" cellspacing="0" cellpadding="0">',
          ).css({ width: '100%' }),
          f = $('<table class="property-page" cellspacing="0" cellpadding="2">');
        (this._table = w.add(T).add(f)),
          ...
          $('<td>').append(t).appendTo(i),
          (o = $('<tr>').appendTo(T)),
          (n = $('<td>').appendTo(o).css({ 'vertical-align': 'top', width: '50%' })),
          (a = $('<td>').appendTo(o).css({ 'vertical-align': 'top', width: '50%' })),
          (l = $('<table class="property-page" cellspacing="0" cellpadding="0">').appendTo(n)),
          (p = $('<table class="property-page" cellspacing="0" cellpadding="0">').appendTo(a)),
  ...
  742: function (e, t, i) {
    ...
    inherit(o, n),
      (o.prototype.prepareLayout = function () {
        ...
        this.bindControl(
          new l(n, this._linetool.properties().color, !0, this.model(), 'Change Text Color'),
        ),
          this.bindControl(
            new r(
              d,
          ...
          this.bindControl(
            new r(h, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font'),
          ),
          this.bindControl(
            new s(c, this._linetool.properties().text, null, !0, this.model(), 'Change Text'),
          ),
          this.bindControl(
            new l(
              u,
          ...
          this.bindControl(
            new p(g, this._linetool.properties().wordWrap, !0, this.model(), 'Change Text Wrap'),
          ),
          this.bindControl(
            new p(C, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold'),
          ),
          this.bindControl(
            new p(
              _,
    ...
    inherit(o, n),
      (o.prototype.addLevelEditor = function (e, t, i) {
        ...
        w.appendTo(this._table),
          ...
          this.bindControl(
            new l(C, t.linewidth, parseInt, this.model(), 'Change Pitchfork Line Width'),
          );
      }),
      (o.prototype.prepareLayout = function () {
        ...
        for (
          ...
          (t = 'level' + e),
            this.addLevelEditor($.t('Level {0}').format(e), this._linetool.properties()[t], !1);
        this.addOneColorPropertyWidget(this._table),
          (i = $(
            '<table class="property-page property-page-unpadded" cellspacing="0" cellpadding="0">',
          ).css({ width: '100%' })),
          ...
          a.appendTo(s),
          (a = $('<tr>')),
          $("<td colspan='5'>").append(s).appendTo(a),
          a.appendTo(this._table),
          this.bindControl(
            new p(
              d,
        ...
        (o.prototype.prepareLayout = function () {
          ...
          (this._block = $('<table class="property-page">')),
            ...
            t.enabled('seconds_resolution') &&
              ...
              (n = $("<input type='checkbox'>").addClass('visibility-checker').prependTo(o)),
              $('<td>').css('padding-right', '15px').append(o).appendTo(i),
              (a = $("<input type='text'>").addClass('ticker-text')),
              $('<td>').append(a).appendTo(i),
              (p = $('<div>').addClass('slider-range ui-slider-horizontal').slider()),
              $('<td>').append(p).appendTo(i),
              (d = $("<input type='text'>").addClass('ticker-text')),
              $('<td>').append(d).appendTo(i),
              this.bindControl(
                new s(n, e.seconds, !0, this.model(), 'Change Line Tool Visibility On Seconds'),
              ),
              this.bindControl(
                new r(
                  p,
            ...
            (h = $("<input type='checkbox'>").addClass('visibility-checker').prependTo(o)),
            ...
            $('<td>').append(d).appendTo(i),
            this.bindControl(
              new s(h, e.minutes, !0, this.model(), 'Change Line Tool Visibility On Minutes'),
            ),
            this.bindControl(
              new r(
                p,
            ...
            (u = $("<input type='checkbox'>").addClass('visibility-checker').prependTo(o)),
            $('<td>').append(o).appendTo(i),
            (a = $("<input type='text'>").addClass('ticker-text')),
            $('<td>').append(a).appendTo(i),
            (p = $('<div>').addClass('slider-range ui-slider-horizontal').slider()),
            ...
            $('<td>').append(d).appendTo(i),
            this.bindControl(
              new s(u, e.hours, !0, this.model(), 'Change Line Tool Visibility On Hours'),
            ),
            this.bindControl(
              new r(
                p,
            ...
            (b = $("<input type='checkbox'>").addClass('visibility-checker').prependTo(o)),
            $('<td>').append(o).appendTo(i),
            (a = $("<input type='text'>").addClass('ticker-text')),
            $('<td>').append(a).appendTo(i),
            (p = $('<div>').addClass('slider-range ui-slider-horizontal').slider()),
            ...
            $('<td>').append(d).appendTo(i),
            this.bindControl(
              new s(b, e.days, !0, this.model(), 'Change Line Tool Visibility On Days'),
            ),
            this.bindControl(
              new r(
                p,
            ...
            $('<td>').append(o).appendTo(i),
            this.bindControl(
              new s(y, e.weeks, !0, this.model(), 'Change Line Tool Visibility On Weeks'),
            ),
            (i = $('<tr>').css('height', '29px').appendTo(this._block)),
            ...
            $('<td>').append(o).appendTo(i),
            this.bindControl(
              new s(g, e.months, !0, this.model(), 'Change Line Tool Visibility On Months'),
            ),
            this.loadData();
        }),
        (o.prototype.widget = function () {
    ...
    inherit(o, a),
      (o.prototype.prepareControl = function (e, t, i) {
        if ('source' === e.id) {
          ...
          return o.appendTo(t), { valueEditor: o, valueSetter: null, propertyChangedHook: null };
        }
  ...
  750: function (e, t, i) {
    ...
    inherit(o, s),
      ...
      (o.prototype._symbolInfoBySymbolProperty = a.prototype._symbolInfoBySymbolProperty),
      ...
      (o.prototype.prepareLayout = function () {
        ...
        (d = r.findStudyMetaInfo(this._model.studiesMetaData(), this._linetool.studyId())),
    ...
    inherit(o, s),
      ...
      (o.prototype.prepareLayout = function () {
        var e,
          ...
          s = $('<table class="property-page" cellspacing="0" cellpadding="2">'),
        ...
        this._prepareSeriesStyleLayout(n, a, s, c),
          (this._table = n.add(a).add(s).add(d).add(h)),
          (e = $('<input type="checkbox">')),
          (t = this.addLabeledRow(d, 'Price Line', e)),
          $('<td>').append(e).prependTo(t),
          this.bindControl(new r(e, c.showPriceLine, !0, this.model(), 'Change Price Price Line')),
          (i = this.createSeriesMinTickEditor()),
          (o = $('<tr>')),
          o.appendTo(h),
          $('<td>' + $.t('Override Min Tick') + '</td>').appendTo(o),
          $('<td>').append(i).appendTo(o),
          this.bindControl(new l(i, c.minTick, null, !0, this.model(), 'Change MinTick')),
    ...
    inherit(o, a),
      (o.prototype.prepareLayout = function () {
        ...
        (this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
          ...
          this.bindControl(
            new s(t, this._study.properties().font, null, !0, this.model(), 'Change Pivots Font'),
          ),
          this.bindControl(
            new s(
              e,
          ...
          this.bindControl(
            new r(i, this._property.levelsStyle.showLabels, !0, g.model(), 'Show Pivot Labels'),
          ),
          ...
          (b = function (e, t, i, o) {
            ...
            for (n = 0; n < e._childs.length; n++)
              (a = e._childs[n]), (s = e[a]), (r = t[a]), (l = i[a]), o(s, r, l, a);
          }),
          b(h, c, u, function (e, t, i, o) {
            ...
            g.bindControl(new r(h, e, !0, g.model(), 'Change ' + o)),
              ...
              $('<td>').append(s).appendTo(n),
              g.bindControl(new p(s, t, !0, g.model(), 'Change ' + o + ' color')),
              (d = g.createLineWidthEditor()),
              $('<td>').append(d).appendTo(n),
              g.bindControl(new l(d, i, !0, g.model(), 'Change ' + o + ' width')),
  ...
  823: function (e, t, i) {
    ...
    (function (e) {
      ...
      function c() {
        return function (e) {
          for (var t = e, i = e.replace(/[^\u0000-\u007F]/, ''); i.length !== t.length; )
            (t = i), (i = t.replace(/[^\u0000-\u007F]/, ''));
          return i;
        };
      }
      ...
      function b(e, t) {
        return function (i) {
          var o = e();
          return i === t.value() && o && (o.ticker || o.full_name) ? o.ticker || o.full_name : i;
        };
      }
      ...
      function L(e, t, i, o, n) {
        ...
        i &&
          e.click(function () {
            var e = $(this).toggleClass('active').hasClass('active');
      ...
      function S(t, i, o, n, a, s) {
        function r(e, t) {
          var i = p.control().slider('option', 'min'),
            ...
            n = p._property.value();
          ((i <= n && n <= o) || (i < t.value && t.value < o)) && p.setValueToProperty(t.value);
        }
        function l(e, t) {
      ...
      function E(e, t, i, o, n, a, s, r) {
        ...
        e.slider({
          ...
          (this.$rangeHandleFrom = $(e.find('.ui-slider-handle')[0]).addClass('from')),
          (this.$rangeHandleTo = $(e.find('.ui-slider-handle')[1]).addClass('to')),
          ...
          a &&
            ...
            $(a[0]).on('keyup', function (e) {
              parseInt($(this).val()) < l._transformers[0]
                ...
                E.prototype.setValueToProperty.call(l, l._control.slider('values'), 'from');
            }),
            $(a[1]).on('keyup', function (e) {
              parseInt($(this).val()) < l._transformers[0]
                ...
                E.prototype.setValueToProperty.call(l, l._control.slider('values'), 'to');
            })),
          this._propFrom.listeners().subscribe(this, E.prototype.propertyChanged),
      ...
      i(866),
        ...
        (n.prototype.loadData = function () {
          ...
          for (e = 0; e < this._bindings.length; e++)
            (t = this._bindings[e]),
              t.properties
                ? ((i = t.properties()), t.setValue(i[0], 0), t.setValue(i[1], 1))
                : t.property &&
        ...
        (n.prototype.saveData = function () {
          var e, t;
          for (this._model.beginUndoMacro(), e = 0; e < this._bindings.length; e++)
            (t = this._bindings[e]),
        ...
        (n.prototype.createLineWidthEditor = function () {
          ...
          return $('<div class="linewidth-slider">', e).slider({ max: 4, min: 1, step: 1 });
        }),
        ...
        (n.prototype.createCombo = function (e) {
          var t = $(document.createElement('select')),
            i = e.reduce(function (e, t) {
              return e.add($(document.createElement('option')).prop({ value: t, text: t }));
            }, $());
          return t.append(i);
        }),
        (n.prototype.createKeyCombo = function (e) {
          ...
          return (
            $.each(e || [], function (e, i) {
              $(document.createElement('option')).prop({ value: e, text: i }).appendTo(t);
            }),
            t
          );
        }),
        (n.prototype.createFontEditor = function (e) {
          var t = e || TradingView.factoryDefaults('chartproperties.editorFontsList');
        ...
        (n.prototype.createPrecisionEditor = function () {
          var e,
            t = "<select><option value='default'>" + $.t('Default') + '</option>';
          for (e = 0; e <= 8; e++) t += "<option value='" + e + "'>" + e + '</option>';
          return (t += '</select>'), $(t);
        }),
        (n.prototype.createLabeledCell = function (e, t, i) {
          var o,
            ...
            r = null;
          return (
            'number' == typeof e.valueOf() ? ((r = e), (o = t), (n = i)) : ((o = e), (n = t)),
            (o += ''),
            (a = this._labelToId(o)),
            (s = $('<td>')),
            $('<label>')
        ...
        (n.prototype.addEditorRow = function (e, t, i, o) {
          ...
          return (i.row = this.addLabeledRow(e, t, i, o)), i.appendTo(n.appendTo(i.row)), i;
        }),
        ...
        (_.prototype.value = function () {
          ...
          return this._disabled
            ...
            : ((e = this._control.val()),
              ...
              i <= t && (t = i - 1),
              1e3 *
                F(this._mainSeries.bars().valueAt(F(this._mainSeries.bars().lastIndex()) - t))[
        ...
        (_.prototype.setValue = function (e) {
          ...
          return this._disabled || null == e
            ...
            : e < 0
            ? (this._control.val(-e), void this._property.setValue(this.value()))
            : null ===
              (t = this._mainSeries
                .data()
                .plotValueToTimePointIndex(e / 1e3, TradingView.TIME_PLOT, M.FromRight))
        ...
        (m.prototype.setValue = function (e) {
          var t = this.value();
          this._transform && (e = this._transform(e)), e && t !== e && this._control.val(e);
        }),
          ...
          if ((this._control.val(e), this._control.selectbox))
            try {
              (t = this._control.find("[value='" + e + "']")),
                t.length > 0 && ((i = t[0]), this._control.selectbox('change', i.value, i.text));
            } catch (e) {}
        }),
        (w.prototype.propertyChanged = function (e) {
          var t = e.value();
          'function' == typeof this._propertyChangedHook && (t = this._propertyChangedHook(t)),
            this.setValue(t);
        }),
        inherit(T, G),
                ...
                : ((n = this.control()),
                  n
                    ...
                    .filter(function () {
                      var e = $(this);
                      return (
                        !e.find('label').length && e.find(':checkbox').attr('id') !== n.attr('id')
                      );
                    })
                    .each(function () {
                      var o = $(this);
        ...
        (v.prototype.setValue = function (e) {
          return (
            (e = !!e),
            this._inverted && (e = !e),
            this.control().parents('label').toggleClass('disabled', e),
        ...
        (x.prototype.setValue = function (e) {
          if (!this._control.is(':disabled')) return f.prototype.setValue.call(this, e);
        }),
        ...
        (P.prototype.setValueToProperty = function (e) {
          this._undoModel.undoHistory.setWatchedValue(this._wv, e, this._undoText);
        }),
        ...
        (B.prototype.value = function () {
          ...
          return (
            this._not && (e = !e), this._transformFunction && (e = this._transformFunction(e)), e
          );
        }),
        ...
        (E.prototype.setValueToProperty = function (e, t) {
          ($(t).hasClass('from') || 'from' === t) &&
            ...
            this._undoModel.setProperty(this._propFrom, e[0], this._undoText[0]),
            this._propFrom.setValue(e[0], 0),
            this._undoModel.endUndoMacro()),
            ($(t).hasClass('to') || 'to' === t) &&
              (this._undoModel.beginUndoMacro(this._undoText[1]),
              this._undoModel.setProperty(this._propTo, e[1], this._undoText[1]),
        ...
        (E.prototype.destroy = function () {
          this._propFrom &&
            this._propTo &&
            (this._propFrom.listeners().unsubscribe(this, G.prototype.propertyChanged),
            this._propTo.listeners().unsubscribe(this, G.prototype.propertyChanged));
        }),
        inherit(R, G),
    ...
    function o(e) {
      ...
      return (
        ...
        (t.prototype.applyTemplate = function (e) {
          this.model().applyLineToolTemplate(this._linetool, e, 'Apply Drawing Template'),
            this.loadData();
        }),
      ...
      (r = (function () {
        ...
        return (
          ...
          (e.prototype.addItems = function (e) {
            var t, i, o;
            for (t = 0, i = e; t < i.length; t++) (o = i[t]), this.addItem(o.value, o.html);
          }),
  ...
  845: function (e, t, i) {
    ...
    function o(e) {
      ...
      return null === o
        ? 0
        : ((t = o[1] ? o[1].length : 0), (i = o[2] ? parseInt(o[2], 0) : 0), Math.max(0, t - i));
    }
    function n(e) {
      return (
        (e = Math.abs(e)),
        !Object(d.isInteger)(e) && e > 1 && (e = parseFloat(('' + e).replace(/^.+\./, '0.'))),
          ...
          this.each(function () {
            ...
            l ? (n = !0) : (l = { step: +a.data('step') || 1 }),
              ...
              n ||
                ...
                (i = $('<div class="tv-ticker__btn tv-ticker__btn--up">').html(h).appendTo(t)),
                (o = $('<div class="tv-ticker__btn tv-ticker__btn--down">').html(h).appendTo(t)),
  ...
  847: function (e, t, i) {
        ...
        (e = $(e)),
          ...
          (h = function (s, h, u) {
            ...
            function y(e) {
              ...
              var t = $(e.target).parents().andSelf();
                ...
                return 1 !== t.tabs.length || t.tabs[0].title
                  ? ((r = $('<div class="charts-popup-tab-group"></div>').appendTo(s)),
                    ...
                    void $.each(t.tabs || [], function (e, i) {
                      ...
                      i.items &&
                        i.items.length &&
                        ((o = $('<div class="charts-popup-tab"></div>').hide().appendTo(r)),
                        ...
                        n.on('click', function (e) {
                          n.is('.active') ||
                            ...
                            o.show(),
                            e && e.preventDefault(),
                            'function' == typeof t.onChange && t.onChange.call(t, i.name));
                        }),
                        (p && !i.active) ||
                          ((p = n),
                          l.find('.charts-popup-tab-header.active').removeClass('active'),
              ...
              return t instanceof a.Group
                ...
                : ((c = $('<a class="item">')),
                  ...
                  t.date
                    ...
                    ? (o.wrapIcon
                        ? c.append(
                            $('<span class="icon-wrap">').addClass(t.iconClass).append(t.svg),
                          )
                        : c.append(t.svg),
                      (y = $('<span class="title"></span>').appendTo(c)))
                    : t.iconClass
                    ? (c.append($('<span class="icon"></span>').addClass(t.iconClass)),
                      (y = $('<span class="title"></span>').appendTo(c)))
                    : (y = $('<span class="title-expanded"></span>').appendTo(c)),
                  t.html ? y.html(t.html) : y.text(TradingView.clean(t.title, !0) || ''),
                  ...
                  void 0 !== t.counter &&
                    ('function' == typeof t.counter
                      ? ((v = $('<span class="counter"></span>').html(t.counter())), v.appendTo(c))
            ...
            switch (
              ...
              (R = x - m.height()),
              (F = 'down'),
              o.direction && (F = 'function' == typeof o.direction ? o.direction() : o.direction),
              (I = !!o.reverse),
              'down' === F
                ? ((D = f - k.top - L - B - P - R),
                  (V = k.top - B - P - R),
              ...
              case 'up':
                'down' === F
                  ...
                  I
                    ? m.css('left', Math.max(k.left + E + v - S, P) + 'px').css('right', 'auto')
              ...
              case 'left':
                (B = Math.max(B, 4)),
                  'right' === F
                    ? m.css('left', Math.floor(k.left + v + B) + 'px').css('right', 'auto')
                    : m
                        .css('left', Math.floor(Math.max(k.left - S - B, P)) + 'px')
                        .css('right', 'auto'),
                  I
                    ? m.css('top', Math.floor(Math.max(k.top + E + L - x, P)) + 'px')
              ...
              m.show(),
                ...
                o.careRightBorder &&
                  ...
                  parseInt(m.css('left')) + m.width() + P > O &&
                    m.css('left', O - m.width() - P + 'px').css('right', 'auto')),
                o.careBottomBorder &&
            ...
            z &&
              ((G = m.offset()),
              m.css({ position: 'fixed', left: G.left - $(j).scrollLeft(), right: 'auto' })),
    ...
    (a.TabGroup = function e(t) {
      ...
      (a.TabGroup.prototype.appendTab = function (e, t, i) {
        if ((null == e ? (e = '') : (e += ''), t || (t = []), i || (i = {}), !Array.isArray(t)))
        ...
        _mouseCapture: function (t) {
          ...
          return (
            ...
            this.handles.each(function (t) {
              ...
              (n > i || (n === i && (t === p._lastChangedValue || p.values(t) === d.min))) &&
                ((n = i), (a = e(this)), (s = t));
            }),
            !1 !== this._start(t, s) &&
        ...
        _uiHash: function (e, t, i) {
          ...
          return (
            this._hasMultipleValues() &&
              ((o.value = void 0 !== t ? t : this.values(e)), (o.values = i || this.values())),
            o
          );
        },
          ...
          this._hasMultipleValues()
            ? this.handles.each(function (o) {
                (i = ((l.values(o) - l._valueMin()) / (l._valueMax() - l._valueMin())) * 100),
                  ...
                  e(this).stop(1, 1)[p ? 'animate' : 'css'](d, r.animate),
                  !0 === l.options.range &&
                    ('horizontal' === l.orientation
                      ? (0 === o &&
                          l.range.stop(1, 1)[p ? 'animate' : 'css']({ left: i + '%' }, r.animate),
                        1 === o &&
                      ...
                      : (0 === o &&
                          l.range.stop(1, 1)[p ? 'animate' : 'css']({ bottom: i + '%' }, r.animate),
                        1 === o &&
                          l.range[p ? 'animate' : 'css'](
                            { height: i - t + '%' },
                            { queue: !1, duration: r.animate },
            ...
            : ((o = this.value()),
              ...
              'min' === s &&
                'horizontal' === this.orientation &&
                this.range.stop(1, 1)[p ? 'animate' : 'css']({ width: i + '%' }, r.animate),
              'max' === s &&
                'horizontal' === this.orientation &&
                this.range.stop(1, 1)[p ? 'animate' : 'css']({ width: 100 - i + '%' }, r.animate),
              'min' === s &&
                'vertical' === this.orientation &&
                this.range.stop(1, 1)[p ? 'animate' : 'css']({ height: i + '%' }, r.animate),
              'max' === s &&
                'vertical' === this.orientation &&
                this.range.stop(1, 1)[p ? 'animate' : 'css']({ height: 100 - i + '%' }, r.animate));
        },
        _handleEvents: {
          keydown: function (t) {
            var i,
    ...
    (function (t) {
      function o(e, i, o) {
        ...
        (this._toolName = e),
          ...
          (this._list = []),
          t.enabled('charting_library_base') || (this.templatesDeferred = this.loadData());
      }
      ...
      (o._cache = {}),
        ...
        (o.prototype.createButton = function (e) {
          ...
          return (
            ...
            (t = $('<a></span></a>')
              ...
              .html(
                e.buttonInner ? e.buttonInner : $.t('Template') + '<span class="icon-dropdown">',
              )),
            n(t, null, {
              event: 'button-popup',
        ...
        (o.prototype.loadTemplate = function (e, t) {
          var i = this;
          return $.get(
            '/drawing-template/' + this._toolName + '/?templateName=' + encodeURIComponent(e),
            function (e) {
        ...
        (o.prototype.removeTemplate = function (e) {
          if (e) {
            var t = this;
            $.post('/remove-drawing-template/', { name: e, tool: t._toolName }).error(function (e) {
              p.logWarn(e.responseText);
            }),
        ...
        (o.prototype.deleteAction = function (e) {
          ...
          runOrSignIn(
            function () {
              var e = $.t(" Do you really want to delete Drawing Template '{0}' ?").format(t);
              l({ type: 'modal', content: e }).then(function (e) {
                e.on('action:yes', function (e) {
