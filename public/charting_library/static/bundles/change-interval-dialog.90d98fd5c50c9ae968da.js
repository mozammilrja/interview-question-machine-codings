          ...
          this.each(function () {
            ...
            d ? (a = !0) : (d = { step: +n.data('step') || 1 }),
              ...
              a ||
                ...
                (i = $('<div class="tv-ticker__btn tv-ticker__btn--up">').html(u).appendTo(o)),
                (e = $('<div class="tv-ticker__btn tv-ticker__btn--down">').html(u).appendTo(o)),
            ...
            (i = i || {}),
              ...
              t
                ? ((s = t.prop('ownerDocument')),
                  ...
                  i.fadeIn
                    ? t.css({ left: g, top: p }).hide().fadeIn('fast')
                    : i.smooth
