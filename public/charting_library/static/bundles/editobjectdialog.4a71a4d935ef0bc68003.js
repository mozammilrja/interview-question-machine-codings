    ...
    (function (t) {
      ...
      i(866),
        ...
        (n.prototype.createKeyCombo = function (t) {
          ...
          return (
            $.each(t || [], function (t, i) {
              $(document.createElement('option')).prop({ value: t, text: i }).appendTo(e);
            }),
            e
          );
        }),
          ...
          this.each(function () {
            ...
            l ? (n = !0) : (l = { step: +a.data('step') || 1 }),
              ...
              n ||
                ...
                (i = $('<div class="tv-ticker__btn tv-ticker__btn--up">').html(u).appendTo(e)),
                (o = $('<div class="tv-ticker__btn tv-ticker__btn--down">').html(u).appendTo(e)),
            ...
            (i = i || {}),
              ...
              t
                ? ((s = t.prop('ownerDocument')),
                  ...
                  i.fadeIn
                    ? t.css({ left: h, top: d }).hide().fadeIn('fast')
                    : i.smooth
