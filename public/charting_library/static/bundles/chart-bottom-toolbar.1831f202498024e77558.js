webpackJsonp([12], {
  ...
  1176: function (e, t) {
    e.exports =
      '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"><path fill="none" stroke="currentColor" stroke-linecap="round" strokeWidth="2" d="M4 8V6a1 1 0 0 1 1-1h2m10 3V6a1 1 0 0 0-1-1h-2M4 12v2a1 1 0 0 0 1 1h2m10-3v2a1 1 0 0 1-1 1h-2"/></svg>';
  },
  1177: function (e, t) {
    e.exports = {
              ...
              t.withModel(null, function () {
                ...
                i.onStatusChanged().subscribe(e, e._updateAvailableRanges),
                  R.enabled('update_timeframes_set_on_symbol_resolve') &&
                    i.dataEvents().symbolResolved().subscribe(e, e._updateAvailableRanges),
                  i.priceScale().properties().lockScale.subscribe(e, e._updateAvailableRanges),
                  i.onIntervalChanged().subscribe(e, e._onRangeChanged),
                  n.model().onResetScales().subscribe(e, e._resetActiveInterval),
                  i.dataEvents().symbolResolved().subscribe(e, e._resetActiveInterval),
      ...
      (ae = (function (e) {
        ...
        return (
          ...
          (t.prototype.componentDidMount = function () {
            ...
            n.withModel(null, function () {
              ...
              e
                ...
                e.model().properties().timezone.subscribe(t, t.updateTimezonesButton);
            }),
              i &&
          ...
          (t.prototype.componentWillUnmount = function () {
            ...
            n.withModel(null, function () {
              ...
              e
                ...
                e.model().properties().timezone.unsubscribe(t, t.updateTimezonesButton);
            }),
              (e = Object(B.ensureNotNull)(this._element)),
          ...
          (t.prototype.updateTimezonesButton = function () {
            ...
            a.model() &&
              null !== a.model().mainSeries().symbolInfo() &&
              ((e = a.model().model().timezone()),
              'exchange' === e &&
                ((t = Object(B.ensureNotNull)(a.model().mainSeries().symbolInfo())),
                (n = t.timezone) && (e = n)),
              (i = Object(Q.a)(e)),
    ...
    var i,
      ...
      o = function (e, t, i) {
        ...
        (e = $(e)),
          ...
          (u = function (s, u, h) {
            function m(t) {
              var n = $(t.target).parents().andSelf();
              n.is(_) ||
                n.is(e) ||
                ...
                return 1 !== t.tabs.length || t.tabs[0].title
                  ? ((r = $('<div class="charts-popup-tab-group"></div>').appendTo(s)),
                    ...
                    void $.each(t.tabs || [], function (e, n) {
                      ...
                      n.items &&
                        n.items.length &&
                        ((i = $('<div class="charts-popup-tab"></div>').hide().appendTo(r)),
