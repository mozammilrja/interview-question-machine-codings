webpackJsonp([1], {
  ...
  1179: function (t, e) {
    t.exports =
      '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14" width="14" height="14"><path stroke="currentColor" stroke-linecap="round" strokeWidth="2" d="M2 7h10"/></svg>';
  },
  1180: function (t, e) {
    t.exports =
      '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 18" width="14" height="18"><g fill="none" stroke="currentColor" stroke-linecap="round" strokeWidth="2"><path d="M1 10a6 6 0 1 0 6-6H3"/><path d="M5 1L2.5 4 5 7"/></g></svg>';
  },
  1181: function (t, e) {
    t.exports =
      '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14" width="14" height="14"><path stroke="currentColor" stroke-linecap="round" strokeWidth="2" d="M7 2v10M2 7h10"/></svg>';
  },
  1182: function (t, e) {
    t.exports =
      '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14" width="14" height="14"><path fill="none" stroke="currentColor" stroke-linecap="round" strokeWidth="2" d="M6.5 1.5l5 5.5-5 5.5M3 4l2.5 3L3 10"/></svg>';
  },
  1183: function (t, e) {
    t.exports =
  ...
  814: function (t, e, i) {
    ...
    (function (t) {
      ...
      var n = (i(34).Study, i(39).trackEvent),
        ...
        h = { contextMenuEnabled: !0, sourceSelectionEnabled: !0, symbolMarkerEnabled: !1 };
      (s.prototype.destroy = function () {
                  ...
                  ((u && t.enabled('fundamental_widget')) ||
                    (s.showLegend || !u
                      ? (u || s.showStudyTitles || s.showStudyValues) &&
                        s.showLegend &&
                        ((p = $('<div>').addClass('pane-legend-line pane-legend-wrap')),
                        ...
                        u
                          ? this._chartHasStudies()
                            ? ((c = $(
                              ...
                              p
                                .addClass('main')
                                .append(c.on('click touchend', this.toggleTitles.bind(this))))
                            : p.addClass('pane-legend-line--without-child-studies')
                          : p.addClass('study'),
                        h.properties().visible.value() || p.addClass('disabled'),
                        ...
                        this._chartHasStudies()
                          ? ((c = $(
                              '<a class="pane-legend-minbtn apply-common-tooltip apply" title="' +
                                $.t('Show') +
                                '"></a>',
                            ).append($(i(1148)).attr({ class: 'expand closed' }))),
                            p.append(c.on('click touchend', this.toggleTitles.bind(this))))
                          : p.addClass('pane-legend-line--without-child-studies'),
                        (p.source = h),
                        h.properties().visible.value() || p.addClass('disabled'),
                        (s = {
        ...
        (s.prototype._generateItemsForRow = function (e, s, n) {
          ...
          if (
            (((y && n.showSeriesTitle) || (!y && n.showStudyTitles)) &&
              ...
              this._options.sourceSelectionEnabled || r.addClass('legend-selection-disabled'),
              y && r.addClass('main'),
              g.properties().visible.value() || r.addClass('disabled'),
              r.css({ 'font-weight': s.bold() ? 'bold' : 'normal', 'font-size': s.size() }),
              ...
              !this._chart.readOnly() &&
                ...
                !y &&
                  ...
                  $(
                    ...
                    .appendTo(o)
                    .on('click touchend', this._generateItemsForRow._onShowhideClick.bind(this, g)),
                !y &&
                  ...
                  $(
                    ...
                    .appendTo(o)
                    .on('click touchend', this._generateItemsForRow._onFormatClick.bind(this, g)),
                !y &&
                  ...
                  $(
                    ...
                    .appendTo(o)
                    .on('click touchend', this._generateItemsForRow._onDeleteClick.bind(this, g)))),
            (l = g.legendView()),
            ...
            for (
              h = [],
                ...
                this._options.contextMenuEnabled || u.addClass('no-context-menu'),
                this._options.sourceSelectionEnabled || u.addClass('legend-selection-disabled'),
                p = 0;
              p < l.items().length;
              p++
            )
              (c = $("<span class='pane-legend-item-value-wrap'>").appendTo(u)),
                (_ = y
                  ? $("<span class='pane-legend-item-value-title pane-legend-line'>").appendTo(c)
                  : null),
                ...
                h.push(v),
                _ && d.push(_);
            (m = $("<span class='pane-legend-item-additional pane-legend-line'>").appendTo(
              u.appendTo(e),
            )),
        ...
        (s.prototype._generateItemsForRow._onFormatClick = function (t, e) {
          t.userEditEnabled() &&
            (TVSettings.setValue('properties_dialog.active_tab.chart', $.t('Style')),
            r(t, this._model));
        }),
        (s.prototype._generateItemsForRow._onDeleteClick = function (t) {
          t.isUserDeletable() &&
            (t.hasChildren()
              ? showDeleteStudyTreeConfirm(this._model.removeSource.bind(this._model, t))
          ...
          for (s = this._itemsBinding.length; s--; )
            (i = this._itemsBinding[s]),
              Array.isArray(i.cell) ||
                ...
                this.valueChanged(n, 'sourceVisible', e) && this.setItemEnabled(i.cell, e),
                (r = i.value.color()),
                (a =
                  o !== this._model.mainSeries() && o === this._model.selectedSource()
                    ? 'bold'
                    : 'normal'),
                ...
                i.isCellInited ||
                  ...
                  d || h
                    ...
                    : ((i.titleElement = i.cell[0]),
                      ...
                      i.descriptionElement.classList.add('apply-overflow-tooltip'))),
                (this.valueChanged(n, 'color', r) || this.valueChanged(n, 'fontWeight', a)) &&
                  ((i.titleElement.style.color = r),
                  (i.titleElement.style.borderColor = r),
                  (i.titleElement.style.fontWeight = a)),
                l !== i.description &&
                  ((i.descriptionElement.textContent = TradingView.clean(l, !0)),
                  (i.description = l)),
                i.intervalElement &&
                  h &&
                  h !== i.interval &&
                  ((i.intervalElement.textContent = TradingView.clean(h, !0)), (i.interval = h)),
                i.detailsElement &&
                  d &&
                  d !== i.details &&
                  ((i.detailsElement.textContent = TradingView.clean(d, !0)), (i.details = d)));
        ...
        (s.prototype.update = function (t) {
          ...
          for (this.updateTitle(), h = this._itemsBinding.length; h--; )
            if (
              ...
              for (
                n.last || ((n.last = {}), n.last.dwView || (n.last.dwView = {})),
                  d = n.last,
                  r = n.value.items(),
                ...
                (l = r[a]),
                  ...
                  i &&
                    (this.valueChanged(d[a], 'sourceVisible', s) && this.setItemEnabled(i[a], s),
        ...
        (s.prototype.renderTo = function (t, e, i) {
          ...
          for (
            t.save(),
              t.fillStyle = this._chart.properties().scalesProperties.textColor.value(),
              ...
              for (
                t =
                  Object(a.getLuminance)(
                    this._chartModel.model().properties().paneProperties.background.value(),
                  ) < 0.5,
                  e = 0,
  ...
  873: function (t, e) {
    t.exports =
      '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14" width="14" height="14"><path fill="none" stroke="currentColor" stroke-linecap="round" strokeWidth="2" d="M8.5 1.5L3.5 7l5 5.5"/></svg>';
  },
  973: function (t, e) {
    t.exports =
      '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14" width="14" height="14"><path fill="none" stroke="currentColor" stroke-linecap="round" strokeWidth="2" d="M5.5 1.5l5 5.5-5 5.5"/></svg>';
  },
  976: function (t, e, i) {
    'use strict';
    function s(t) {
