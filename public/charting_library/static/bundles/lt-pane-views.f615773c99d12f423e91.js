webpackJsonp([0], {
    ...
    function n(e, t, i, n) {
      return null !== e
        ? Object(a.intersectPolygonAndHalfplane)(
            e,
            Object(r.halfplaneThroughPoint)(Object(r.lineThroughPoints)(t, i), n),
          )
        : null;
    }
      ...
      (p = (function () {
        ...
        return (
          ...
          (e.prototype._extendAndHitTestLineSegment = function (e, t, i) {
            ...
            return null !== s && ((n = Object(o.distanceToSegment)(s[0], s[1], e)), n.distance <= 3)
              ? this._hittestResult
              : null;
          }),
          ...
          (e.prototype._drawBackground = function (e, t) {
            ...
            if (
              ...
              for (e.beginPath(), e.moveTo(a[0].x, a[0].y), l = 1; l < a.length; l++)
          ...
          (e.prototype.draw = function (e) {
            if (
              ...
              if (
                ...
                t.addColorStop(
                  0,
                  Object(s.generateColor)(this._data.color1, this._data.transparency),
                ),
                  t.addColorStop(
                    1,
                    Object(s.generateColor)(this._data.color2, this._data.transparency),
                  ),
                  (e.fillStyle = t);
              } else
            ...
            return null === this._data
              ...
              : ((t = e.subtract(this._data.center)),
                ...
                r <= o)
                  ...
                  : this._data.fillBackground &&
                    i <= this._data.radius &&
                    ((a = this._data.p1.subtract(this._data.center).normalized()),
            ...
            return null === this._data
              ...
              : ((e = e.subtract(this._data.center)),
                ...
                Math.abs(a - o) < 5 && t.x * e.x >= 0 && t.y * e.y >= 0
                  ...
                  : this._data.fillBack && a >= h && a <= o && t.x * e.x >= 0 && t.y * e.y >= 0
    ...
    function n(e, t, i, n) {
      ...
      return null !== e && null !== s
        ? Object(c.intersectPolygonAndHalfplane)(
            e,
            Object(l.halfplaneThroughPoint)(Object(l.lineThroughPoints)(t, i), s),
          )
        : null;
    }
    function s(e) {
          ...
          (e.prototype.draw = function (e) {
            ...
            if (!(null === this._data || this._data.points.length < 4))
              for (
                ...
                for (n = i[t], e.beginPath(), e.moveTo(n[0].x, n[0].y), s = 1; s < n.length; s++)
          ...
          (e.prototype.hitTest = function (e) {
            ...
            for (t = 0, i = this._visiblePolygons(); t < i.length; t++)
              if (((n = i[t]), Object(h.pointInPolygon)(e, n)))
                return new u.HitTestResult(u.HitTestResult.MOVEPOINT_BACKGROUND);
            return null;
          }),
  ...
  213: function (e, t, i) {
    ...
    inherit(n, p),
      (n.prototype.renderer = function () {
        ...
        if ((this._invalidated && (this.updateImpl(), (this._invalidated = !1)), !this._wave))
          return null;
        for (
        ...
        for (
          p = 1,
            this._points.length > 2 &&
              ((v = this._points[2]), (w = this._points[1]), (p = g.sign(v.y - w.y))),
            y = [],
            m = 0,
          ...
          n < e ||
            ...
            'circle' === S.decoration &&
              ...
              1 === p ? (T.y += 13 + S.fontIncrease / 2) : (T.y -= 14 + S.fontIncrease / 2),
        ...
        if (this.isAnchorsRequired()) {
          for (B = [], A = 0; A < y.length; A++)
            (M = this._points[A].clone()), (M.y = y[A].points[0].y), (M.data = A), B.push(M);
      ...
      (n.prototype.updateImpl = function () {
        ...
        if (
          ...
          t && !t.isEmpty() && !i.isEmpty() && ((n = e.color.value()), e.showWave.value()))
        )
          for (
            r = this._source.ownerSource().firstValue(), o = this._source.points(), a = 1;
            a < o.length;
            a++
          )
            (l = o[a - 1]),
          ...
          !(e = this._source.priceScale()) || e.isEmpty()
            ...
            : ((t = {}),
              ...
              n ||
                ...
                i.fixedSize.value() ||
                ((t.scaleX =
                  this._source._model.timeScale().barSpacing() / this._source._barSpacing),
        ...
        if (
          ...
          for (
            e = this._points,
              ...
              this._edge2 = c,
              d < c &&
                ((this._edge1 = Math.max(d, c)), (this._edge2 = Math.min(d, c) + 2 * Math.PI)),
            ...
            (_ = 'level' + u),
              ...
              f.visible.value() &&
                ...
                (y = o.add(a).scaled(0.5).normalized().scaled(w)),
                (m = t.add(y)),
                this._levels.push({
                  coeff: g,
                  color: v,
          ...
          if (
            ...
            switch (p.horzLabelsAlign.value()) {
              case 'left':
                ...
                break;
              case 'center':
                (S = t.add(i).scaled(0.5)), (S.x += R.width / 2), (S.x = Math.round(S.x));
                break;
              case 'right':
                p.extendLines.value()
            ...
            (P = {
              ...
              (T = { left: S.x - P.width, top: S.y, width: R.width, height: P.height }),
        ...
        function e(e, n, s) {
          ...
          switch (i.horzLabelsAlign.value()) {
            case 'left':
              ...
              break;
            case 'center':
              (r = e.add(n).scaled(0.5)), (r.x += s.width / 2), (r.x = Math.round(r.x));
              break;
            case 'right':
  ...
  755: function (e, t, i) {
    ...
    (n.prototype.draw = function (e) {
      ...
      (n.prototype.hitTest = function (e) {
        var t, i, n;
        return o.sign(e.y - this._data.center.y) === this._data.dir || this._data.fullCircles
          ? ((t = e.subtract(this._data.center)),
            (i = t.length()),
            (n = 3),
          ...
          if (
            ...
            switch (n.horzLabelsAlign.value()) {
              case 'left':
                ...
                break;
              case 'center':
                (T = t.add(i).scaled(0.5)), (T.x += P.width / 2), (T.x = Math.round(T.x));
                break;
              case 'right':
                n.extendLines.value()
            ...
            (L = {
              ...
              (C = { left: T.x - L.width, top: T.y, width: P.width, height: L.height }),
          ...
          for (
            ...
            (h = 'level' + l),
              ...
              d.visible.value() &&
                ...
                (p = d.color.value()),
                (u = []),
                u.push(new s(this._center.x - 0.5 * i * c, this._center.y - 0.5 * n * c)),
                u.push(new s(this._center.x + 0.5 * i * c, this._center.y + 0.5 * n * c)),
  ...
  759: function (e, t, i) {
    'use strict';
    function n(e, t) {
      r.call(this, e, t), (this._invalidated = !0), (this._lineRenderer = new l());
    }
    var s = i(6).Point,
      r = i(824).LineSourcePaneView,
      ...
      (n.prototype.renderer = function () {
        ...
        return (
          ...
          TradingView.printing ||
            ...
            1 !== e.points.length ||
            ((i = new s(this._points[0].x, this._source.priceScale().height() / 2)),
      ...
      (n.prototype.renderer = function () {
        ...
        if (
          ...
          if (
            ...
            (r = Math.abs((this._points[0].x - this._points[1].x) / (this._pattern.length - 1))),
            ...
            for (
              ...
              (w = Math.round(i.x + v * r + 0.5)),
                ...
                o.append(b);
            return (
              this.isAnchorsRequired() && o.append(this.createLineAnchor({ points: this._points })),
              o
            );
          }
          return (
            ...
            ? ((e = this._source.priceScale()),
              ...
              (_ = {
                ...
                6: function (e, t) {
                  return new s(
                    p + t * u,
                    o((e[TradingView.HIGH_PLOT] + e[TradingView.LOW_PLOT]) / 2) + c.y,
                  );
                },
              }),
          ...
          for (a = 1; a <= 11; a++)
            (l = 'level' + a),
              ...
              h.visible.value() &&
                ...
                s.showCoeffs.value() && ((_.text = d), (_.y = this._source.priceScale().height())),
                this._levels.push(_));
      }),
      (n.prototype.renderer = function () {
        ...
        for (
          ...
          if (
            (v > 0 &&
              ...
              ((w = this._levels[v - 1]),
              (t = new s(w.x, 0)),
              (i = new s(this._levels[v].x, this._source.priceScale().height())),
              (y = {}),
              (y.points = [t, i]),
            ...
            switch (n.vertLabelsAlign.value()) {
              case 'top':
                ...
                break;
              case 'middle':
                (x = new s(this._levels[v].x, 0.5 * this._levels[v].y)), (R = 0);
                break;
              case 'bottom':
    ...
    inherit(n, r),
      ...
      (n.prototype.updateImpl = function () {
        ...
        if (
          ...
          for (this._levels = [], s = t ? t.index - e.index : 1, o = 1; o <= 11; o++)
            (a = i['level' + o]),
              a.visible.value() &&
                ...
                i.showLabels.value() &&
                  ((d.text = a.coeff.value()), (d.y = this._source.priceScale().height())),
                this._levels.push(d));
      }),
      (n.prototype.renderer = function () {
          ...
          if (
            ...
            switch (n.vertLabelsAlign.value()) {
              case 'top':
                ...
                break;
              case 'middle':
                (y = new s(this._levels[r].x, 0.5 * this._levels[r].y)), (x = 0);
                break;
              case 'bottom':
          ...
          this._points.length < 2 || this._source.points().length < 2
            ...
            : ((i = this._source.properties()),
              ...
              i.fillLabelBackground &&
                ...
                (f.backgroundTransparency = 1 - i.labelBackgroundTransparency.value() / 100 || 0)),
              i.drawBorder && i.drawBorder.value() && (f.borderColor = i.borderColor.value()),
              (B = 0.5 * (o.x + a.x)),
              (A = a.y),
              (M = new s(B, A)),
          ...
          this._points.length < 2 || this._source.points().length < 2
            ...
            : ((t = this._source.properties()),
              ...
              S &&
                ...
                ((this._pipFormatter = new c(S.pricescale, S.minmov, S.type, S.minmove2)),
                (this._lastSymbolInfo = S)),
              (P = u(
                this._source.ownerSource().formatter().format(b) +
                  ' (' +
        ...
        return (
          ...
          this._points.length < 2 || this._source.points().length < 2
            ...
            : ((t = this._source.properties()),
              ...
              T &&
                L &&
                ((k = (L.valueOf() - T.valueOf()) / 1e3), (C = ', ' + g(new c().format(k)))),
              (I = this._model.mainSeries().symbolInfo()),
              I &&
                I !== this._lastSymbolInfo &&
                ((this._pipFormatter = new p(I.pricescale, I.minmov, I.type, I.minmove2)),
            ...
            3 === this._points.length &&
              ...
              r.isLog()
                ? ((a = 0.5 * (i + n) - this._source._priceOffset),
                  ...
                  (this._p3.y += c),
                  (this._p4.y += c))
                : ((this._p3.y = this._source.priceScale().priceToCoordinate(i, o)),
                  (this._p4.y = this._source.priceScale().priceToCoordinate(n, o)))));
      }),
      (n.prototype.renderer = function () {
        var e, t, i, n, s, r;
        return (
          ...
          this.isAnchorsRequired() &&
            ...
            this._p3 &&
              (n.push(this._p3.add(this._p4).scaled(0.5)), (n[n.length - 1].data = n.length - 1)),
          ...
          this._source.points().length < 2 ||
            ...
            this._source.properties().showPriceRange.value() &&
              ...
              _ &&
                ...
                ((this._pipFormatter = new u(_.pricescale, _.minmov, _.type, _.minmove2)),
                (this._lastSymbolInfo = _)),
              (f = this._pipFormatter ? ', ' + this._pipFormatter.format(d) : ''),
              (l += f),
              a.push('priceRange')),
        ...
        return (
          ...
          this._secondPoint &&
            ...
            n &&
              ...
              (o = this._source.getPointByPosition(r, t.points[0], this._middlePoint, t.points[1])),
              (l = {
                points: [o],
                text: this._label,
            ...
            s && this._middlePoint && e.append(new p({ points: [this._middlePoint] })),
            (c = {}),
          ...
          this._labelDataInvalidated &&
            ...
            u &&
              ...
              g &&
                ...
                ((this._pipFormatter = new p(g.pricescale, g.minmov, g.type, g.minmove2)),
                (this._lastSymbolInfo = g)),
              (o += this._pipFormatter ? ', ' + this._pipFormatter.format(h) : ''),
              r.push('priceRange')),
            ...
            (y || m || x) &&
              ((a = ''),
              y && ((d = i.index - t.index), (a += $.t('{0} bars').format(v(d)))),
              m &&
              ...
              x &&
                ...
                (a += $.t('distance: {0}').format(v(this._numericFormatter.format(T))))),
              a && r.push('barsRange')),
            (L = n.showAngle.value()),
            L &&
              ...
              C instanceof s &&
                ...
                ((B = k.subtract(C)),
                B.length() > 0 &&
                  ((B = B.normalized()), (I = Math.acos(B.x)), B.y > 0 && (I = -I))),
              'number' != typeof I ||
                TradingView.isNaN(I) ||
          ...
          this._invalidated
            ...
            ? ((t = {}),
              ...
              n &&
                ...
                (_ = new o(p.get(0), d, c)),
                e.append(_)),
              s && this._middlePoint && e.append(new u({ points: [this._middlePoint] })),
              this.addAnchors(e),
              !TradingView.printing &&
                this._source.hasAlert.value() &&
                !this._model.readOnly() &&
  ...
  771: function (e, t, i) {
    ...
    (n.prototype._textWidth = function (e) {
      ...
      (n.prototype.hitTest = function (e) {
        ...
        return (
          'buy' === this._adapter.getDirection() ? ((t = r), (i = r + o)) : ((t = r - o), (i = r)),
          e.x >= s - 2 && e.x <= s + 2 && e.y >= t && e.y <= i
            ? ((n = this._adapter.getTooltip()),
              new l(l.CUSTOM, {
                ...
                tooltip: '' !== n ? { text: n, rect: { x: s, y: t, w: 2, h: i - t } } : null,
              }))
            : null
        );
      }),
  ...
  773: function (e, t, i) {
    'use strict';
    function n(e, t) {
      r.call(this, e, t), (this._numericFormatter = new d()), (this._invalidated = !0);
    }
    var s = i(6).Point,
      r = i(824).LineSourcePaneView,
      o = i(186).TextRenderer,
  ...
  774: function (e, t, i) {
    'use strict';
    function n(e, t) {
      r.call(this, e, t), (this._numericFormatter = new c()), (this._invalidated = !0);
    }
    var s = i(6).Point,
      r = i(824).LineSourcePaneView,
        ...
        return (
          ...
          (t.prototype._updateImpl = function () {
            ...
            e.prototype._updateImpl.call(this),
              ...
              i.length < 2 ||
                n.length < 2 ||
                ((s = n[0]), (r = n[1]), (i[1] = s), (i[1].data = 1), (i[2] = r));
          }),
          (t.prototype._initRenderers = function () {
            var e,
              t,
          ...
          for (
            ...
            (l = 'level' + a),
              ...
              h.visible.value() &&
                ...
                (u = h.color.value()),
                (_ = d + '/' + c),
                d > c ? ((s = t.x), (o = e.y + n / p)) : ((s = e.x + i * p), (o = t.y)),
                this._fans.push({
                  label: _,
                  color: u,
                  x: s,
            ...
            : ((t = this._points[0]),
              ...
              2 === this._points.length
                ...
                : (this._trendLineRendererPoints43.setData(f(s, n)),
                  ...
                  v(this._p3LabelRenderer, this._p4LabelRenderer, n, s, this._price3, this._price4),
                  this.isAnchorsRequired() &&
                    ((w = [t, i, n, s]),
            ...
            : ((t = this._points[0]),
              ...
              2 === this._points.length
                ...
                : ((f = this),
                  ...
                  e.append(this._trendLineRendererPoints43),
                  g(this._p3LabelRenderer, this._p4LabelRenderer, n, s, this._price3, this._price3),
                  this.isAnchorsRequired() &&
                    ((v = [t, i, n, s]),
  ...
  782: function (e, t, i) {
    'use strict';
    function n(e, t) {
      o.call(this, e, t), (this._invalidated = !0), (this._poligonRenderer = new l());
    }
    var s = i(6).Point,
  ...
  783: function (e, t, i) {
    ...
    (n.prototype.setData = function (e) {
      ...
      (n.prototype._continiusFib = function (e) {
        ...
        return r >= n.length
          ? null
          : ((t = e - s), (t = Math.pow(t, 1.15)), (i = n[r] - n[s]), n[s] + i * t);
      }),
      (n.prototype.hitTest = function (e) {
        var t, i, n, s, r, o, l, h, d, c, p, u, _, f;
        ...
        return (
          ...
          this._floatPoints.length < 2
            ...
            : ((t = {}),
              ...
              (t.linewidth = this._source.properties().linewidth.value()),
              (t.linestyle = this._source.properties().linestyle.value()),
              (t.counterclockwise = this._source.properties().counterclockwise.value()),
      ...
      (n.prototype.renderer = function () {
        ...
        return (
          this._points.length >= 5 &&
            ((f = !1),
            (g = !1),
            this._intersect1 ? (u = this._intersect1) : ((u = this._points[2]), (f = !0)),
            this._intersect2 ? (_ = this._intersect2) : ((_ = this._points[4]), (g = !0)),
            (l = s(u, _, 0)),
            (l.extendleft = f),
            (l.extendright = g),
      ...
      (n.prototype.updateImpl = function () {
        ...
        r.prototype._updateImpl.call(this),
          ...
          this._points.length >= 5 &&
            ...
            (n = this._points[4]),
            (o = s(i, n, e, t)),
            null !== o && ((a = n.subtract(i)), (this._intersect1 = i.add(a.scaled(o)))),
            7 === this._points.length &&
              ((l = this._points[5]),
              (h = this._points[6]),
              null !== (o = s(i, n, l, h)) &&
                ((a = n.subtract(i)), (this._intersect2 = i.add(a.scaled(o))))));
      }),
            ...
            : ((e = this._source.properties()),
              ...
              4 === this._points.length &&
                ...
                this._intersectPoint
                  ? ((o = [this._startPoint1, this._startPoint2, this._intersectPoint]),
                    (a = {}),
                    (a.points = o),
      ...
      (n.prototype.updateImpl = function () {
        ...
        s.prototype._updateImpl.call(this),
          ...
          this._source.points().length >= 4 &&
            ...
            (this._retrace1 =
              Math.round(100 * Math.abs((i.price - t.price) / (t.price - e.price))) / 100)),
          this._source.points().length >= 6 &&
            ((i = this._source.points()[3]),
            (n = this._source.points()[4]),
            (r = this._source.points()[5]),
            (this._retrace2 =
              Math.round(100 * Math.abs((r.price - n.price) / (n.price - i.price))) / 100));
      }),
        ...
        return (
          ...
          this._points.length < 2 || this._source.points().length < 2
            ...
            : ((t = this),
              ...
              this._points[1] &&
                void 0 !== this._pl &&
                (O = this._source.ownerSource().formatter().format(this._pl)),
              i.compact.value()
                ? ((M += O ? O + ' ~ ' : ''), (M += i.qty.value() + '\n'), (M += D))
              ...
              V &&
                ...
                ((this._pipFormatter = new u(V.pricescale, V.minmov, V.type, V.minmove2)),
                (this._lastSymbolInfo = V)),
              (A = new s((n + a) / 2, this._stopLevel)),
              (M = ''),
              (z = this._source.ownerSource().formatter().format(L)),
              (H = this._percentageFormatter.format(C)),
              (M = i.compact.value()
                ? z + ' (' + H + ') ' + i.amountStop.value()
                : this.i18nCache.stop.format(
                    v(this._source.ownerSource().formatter().format(L)),
              ...
              (M = ''),
              (z = this._source.ownerSource().formatter().format(k)),
    ...
    (n.prototype.setData = function (e) {
      ...
      (n.prototype.drawTargetLabel = function (e) {
        ...
        if (
          ...
          (e.font = 'normal ' + this._targetFontSize3 + 'px ' + this._font),
          e.fillText(this._data.targetLine1, h.x + c + u, h.y + this._targetFontSize1 + p),
          (_ = 13),
          (f = 5),
          (g = c + i + f),
          (v = x(e, o - 2 * g)),
          e.fillText(this._data.targetLine2, h.x + g + v, h.y + this._targetFontSize1 + p),
          (e.font = 'normal ' + this._targetFontSize2 + 'px ' + this._font),
          ...
          (S = c + s + 5),
          (P = x(e, o - 2 * S - _ + 1)),
          e.drawImage(this._data.clockWhite, h.x + S + 1 + P, w - this._targetFontSize2 + 3),
          (T = S + _),
          (L = x(e, o - 2 * T)),
        ...
        h.prototype._updateImpl.call(this),
          ...
          this._source.points().length < 2 ||
            (this._source.priceScale() &&
              ...
              (a = i.time && t.time),
              a &&
                ((r = TradingView.isString(i.time) ? new Date(Date.parse(i.time)) : i.time),
                (o = TradingView.isString(t.time) ? new Date(Date.parse(t.time)) : t.time)),
              ...
              o &&
                ...
                l ||
                  (this._targetLine4 =
                    this._targetLine4 + '  ' + new v(c ? '%h:%m:%s' : '%h:%m').format(o)),
                (p = (o.valueOf() - r.valueOf()) / 1e3),
                (this._targetLine2 = $.t('in', { context: 'dates' }) + ' ' + P(new w().format(p)))),
              ...
              u &&
                ...
                l ||
                  (this._sourceLine2 =
                    this._sourceLine2 + ' ' + new v(c ? '%h:%m:%s' : '%h:%m').format(u))),
    ...
    (n.prototype.setData = function (e) {
      ...
      (s.prototype.updateImpl = function () {
        ...
        if ((a.prototype._updateImpl.call(this), this._source.points().length > 0)) {
          if (
            ((e = this._source.points()[0].price), !(t = this._source.priceScale()) || t.isEmpty())
          )
            return;
  ...
  793: function (e, t, i) {
    ...
    (n.prototype.update = function (e) {
      ...
      (n.prototype.drawOn = function (e) {
        var t = new o(Math.round(this._data.point.x), Math.round(this._data.point.y)).add(
          this._translate,
        );
      ...
      (s.prototype.draw = function (e) {
        null !== this._data &&
          (this._source.drawOn(e), this._data.tooltipVisible && this.drawTooltipOn(e));
      }),
      (s.prototype.drawTooltipOn = function (e) {
        ...
        for (
          e.save(),
            ...
            l < 10
              ? (l += Math.abs(l - 10))
              : l + o + 10 > this._data.vpWidth && (l -= l + o + 10 - this._data.vpWidth),
            ...
            e.beginPath(),
            e.moveTo(l, d),
            c || 'top' !== p || (e.lineTo(f - 7, d), e.lineTo(f, d - 7), e.lineTo(f + 7, d)),
            e.lineTo(l + o, d),
            e.lineTo(l + o, d + a),
            c ||
              'bottom' !== p ||
              (e.lineTo(f + 7, d + a), e.lineTo(f, d + a + 7), e.lineTo(f - 7, d + a)),
            e.lineTo(l, d + a),
            e.closePath(),
            e.fill(),
            e.stroke(),
          ...
          e.fillText(n[y].replace(/^\s+/, ''), v, w), (w += this._data.fontSize + r);
        e.restore();
      }),
  ...
  795: function (e, t, i) {
    ...
    (n.prototype.setData = function (e) {
      ...
      (n.prototype.draw = function (e) {
        ...
        if (!(null === this._data || this._data.points.length < 2)) {
          if (
            ((t = this._data.points[0]), (i = this._data.points[1]), this._data.points.length < 3)
          )
            return (
              (e.strokeStyle = this._data.color),
              (e.lineWidth = this._data.linewidth),
          ...
          (a = i.subtract(t)),
            ...
            this._data.clockwise
              ? e.arc(0.5 * _, (_ * Math.sqrt(3)) / 2, _, (-2 * Math.PI) / 3, -Math.PI / 3, !1)
              : e.arc(0.5 * _, (-_ * Math.sqrt(3)) / 2, _, Math.PI / 3, (2 * Math.PI) / 3, !1),
            e.restore(),
            e.stroke(),
            this._data.fillBackground &&
        ...
        for (t.font = this.fontStyle(), r = [], o = 0; o < s.length; o++)
          if (((a = s[o]), (l = t.measureText(a).width) <= n)) r.push(a);
            ...
            for (h = a.split(/([-\)\]\},.!?:;])|(\s+)/); h.length; ) {
              ...
              if (d > 0) r.push(h.slice(0, 3 * d - 1).join('')), h.splice(0, 3 * d);
              else {
                if (
                  ((c = h[0] + (h[1] || '')),
                ...
                p < 1 && (p = 1), r.push(c.substr(0, p)), (h[0] = c.substr(p)), (h[1] = '');
              }
          ...
          for (
            t = this._data.points[0].clone(),
              ...
              10 === _
                ...
                : e.lineTo(a - r, 0),
              20 === _ ? (e.lineTo(t.x, t.y), e.lineTo(a, r)) : e.arcTo(a, 0, a, r, r),
              21 === _
                ? g
                  ? (e.lineTo(a, i.y - r),
                    e.lineTo(t.x, t.y),
                ...
                : e.lineTo(a, l - r),
              22 === _ ? (e.lineTo(t.x, t.y), e.lineTo(a - r, l)) : e.arcTo(a, l, a - r, l, r),
              12 === _
                ? f
                  ? (e.lineTo(i.x + r, l), e.lineTo(t.x, t.y), e.lineTo(i.x - r, l), e.lineTo(r, l))
                  : (e.lineTo(t.x, t.y), e.lineTo(r, l))
                : e.lineTo(r, l),
              2 === _ ? (e.lineTo(t.x, t.y), e.lineTo(0, l - r)) : e.arcTo(0, l, 0, l - r, r),
              1 === _
                ? g
                  ? (e.lineTo(0, i.y + r), e.lineTo(t.x, t.y), e.lineTo(0, i.y - r), e.lineTo(0, r))
                  : (e.lineTo(t.x, t.y), e.lineTo(0, r))
                : e.lineTo(0, r),
              0 === _ ? (e.lineTo(t.x, t.y), e.lineTo(r, 0)) : e.arcTo(0, 0, r, 0, r),
              e.stroke(),
    ...
    (n.prototype.setData = function (e) {
      ...
      (n.prototype.draw = function (e) {
        ...
        null !== this._data &&
          ...
          this._measureCache &&
            $.extend(this._measureCache, { innerWidth: s, innerHeight: r, padding: n }),
    ...
    inherit(n, r),
      ...
      (n.prototype.renderer = function () {
        ...
        return (
          ...
          1 === this._points.length &&
            this.isAnchorsRequired() &&
            ((p = new s(this._model.timeScale().width() / 2, this._points[0].y)),
            (p.data = 0),
          ...
          TradingView.printing ||
            ...
            this._model.readOnly() ||
            1 !== this._points.length ||
            ((u = new s(this._model.timeScale().width() / 2, this._points[0].y)),
            this._source.getAlertIsActive(function (i) {
              e.append(
                new d({
                  point1: u,
        ...
        return (
          ...
          this._source.properties().showLabel.value() &&
            ...
            'right' === s
              ...
              : 'center' === s && (r.x = (r.x + this._model.timeScale().width()) / 2),
            'middle' === n
      ...
      (n.prototype.draw = function (e) {
        ...
        if (!(null === this._data || this._data.points.length < 2)) {
          ...
          (a = i.subtract(t)),
            ...
            e.rotate(w),
            e.scale(1, (2 * s) / _),
            e.arc(0, 0, 0.5 * _, this._data.angleFrom, this._data.angleTo, this._data.clockwise),
            e.restore(),
            e.stroke(),
            this._data.fillBackground &&
              ((e.fillStyle = f.generateColor(this._data.backcolor, this._data.transparency)),
    ...
    (n.prototype.setData = function (e) {
      ...
      (n.prototype.hitTest = function (e) {
        ...
        return null === this._data || e.y > this._data.point.y
          ...
          ? null
          : ((t = new r(this._data.point.x + this._data.width / 2, this._data.point.y)),
            (i = e.subtract(t)),
  ...
  803: function (e, t, i) {
    ...
    (n.prototype.draw = function (e) {
      ...
      (s.prototype.renderer = function () {
        ...
        for (g = g = f.indexToCoordinate(s + a), w = s + a; g < f.width(); w += a)
          (g = f.indexToCoordinate(w)), v.push(g);
      ...
      (n.prototype.draw = function (e) {
        ...
        if (null !== this._data)
          if (
            ...
            for (
              e.quadraticCurveTo(r.x, r.y, n.x, n.y), e.quadraticCurveTo(o.x, o.y, i.x, i.y), h = 0;
      ...
      (n.prototype.hitTest = function (e) {
        ...
        if (null !== this._data && 3 === this._data.points.length) {
          if (
            ...
            p.quadroBezierHitTest(n, t, o, e) || p.quadroBezierHitTest(n, i, a, e))
          )
        ...
        return this._points.length < 2
          ...
          : (this._invalidated && (this.updateImpl(), (this._invalidated = !1)),
            ...
            this._source._controlPoint &&
              e.push(this._source.pointToScreenPoint(this._source._controlPoint)[0]),
            (t = {}),
            (i = this._source.properties()),
            (t.points = e),
        ...
        if (null !== this._data)
          if (
            ...
            if (
              ...
              for (
                _ = this._data.extendLeftPoints[this._data.extendLeftPoints.length - 1],
                  e.moveTo(_.x, _.y),
      ...
      (n.prototype.updateImpl = function () {
        ...
        s.prototype._updateImpl.call(this),
          ...
          this._source.points().length >= 4 &&
            ((n = this._source.points()[3]),
            (this._BCRetracement =
              Math.round(1e3 * Math.abs((n.price - e.price) / (t.price - e.price))) / 1e3)),
          this._source.points().length >= 5 &&
            ((r = this._source.points()[4]),
            (this._CDRetracement =
              Math.round(1e3 * Math.abs((r.price - n.price) / (n.price - i.price))) / 1e3),
            (this._XDRetracement =
              Math.round(1e3 * Math.abs((r.price - n.price) / (e.price - n.price))) / 1e3));
      }),
      (t.CypherPaneView = n);
  },
  808: function (e, t, i) {
    ...
    (n.prototype.setData = function (e) {
      ...
      (n.prototype._drawQuantity = function (e, t, i, n) {
        ...
        e.save(),
          ...
          n && e.clip && (e.beginPath(), e.rect(t + 0.5, i - 0.5, s + 1, r + 1), e.clip()),
      ...
      (n.prototype.draw = function (e) {
        ...
        null === this._data ||
          ...
          0 !== i &&
            ...
            (c = !0)),
          0 !== n &&
            (this._drawQuantity(e, l + i, d, c), this._drawQuantityText(e, l + i, d), (c = !0)),
  ...
  867: function (e, t, i) {
    ...
    inherit(n, r), (t.PaneRendererClockIcon = TradingView.PaneRendererClockIcon = n);
  },
  877: function (e, t, i) {
    'use strict';
    var n, s, r;
          ...
          (e.prototype.draw = function (e) {
            if (
              ...
              t < 0 ||
                ...
                (e.strokeStyle = this._data.color),
                (e.lineWidth = this._data.linewidth),
                void 0 !== this._data.linestyle && Object(s.setLineStyle)(e, this._data.linestyle),
    ...
    function n(e, t, i, n) {
      ...
      return null !== e && null !== s
        ? Object(l.intersectPolygonAndHalfplane)(
            e,
            Object(r.halfplaneThroughPoint)(Object(r.lineThroughPoints)(t, i), s),
          )
        : null;
    }
    var s, r, o, a, l, h, d, c;
        ...
        return (
          ...
          (e.prototype.hitTest = function (e) {
            ...
            if (
              ...
              return null;
            for (t = o.CheckMobile.any() ? 24 : 3, i = 1; i < this._points.length; i++)
              if (
                ((r = this._points[i - 1]),
                (a = this._points[i]),
                  ...
                  : ((l = this._data.points[2]),
                    ...
                    a.distance <= 3
                      ...
                      : ((a = Object(s.distanceToSegment)(l, i, e)),
                        a.distance <= 3
                          ? new n.HitTestResult(n.HitTestResult.MOVEPOINT)
                          : this._data.fillBackground && Object(r.pointInTriangle)(i, o, l, e)
                          ? new n.HitTestResult(n.HitTestResult.MOVEPOINT_BACKGROUND)
                          : null)));
          }),
          e
        );
