          ...
          (r.fn = r.prototype =
            {
              ...
              offset: function () {
                ...
                return {
                  top:
                    t.top + (e.pageYOffset || document.scrollTop || 0) - (document.clientTop || 0),
                  left:
                    t.left +
      ...
      (function (i) {
        ...
        return (function (e, t, r, n) {
            ...
            if (e)
              for (
                ...
                if (y.State.calls[i]) {
                  ...
                  for (
                    b = s[6] = t - c, x = Math.min(b / u.duration, 1), S = 0, k = l.length;
                    S < k;
                    S++
                  )
                              ...
                              : (v.Hooks.registered[N] &&
                                ...
                                v.Hooks.registered[N] &&
                                  (v.Normalizations.registered[z]
                                    ? (o(C).rootPropertyValueCache[z] = v.Normalizations.registered[
                                        z
                                      ]('extract', null, M[1]))
                  ...
                  u.display !== n && 'none' !== u.display && (y.State.calls[i][2].display = !1),
                    ...
                    u.progress &&
                      u.progress.call(s[1], s[1], x, Math.max(0, c + u.duration - t), c, m),
                    1 === x && f(i);
                }
          ...
          var g,
              ...
              try {
                ...
                return function (t, r) {
                  var n,
                    ...
                    l = this.length;
                  if (
                    ('number' != typeof t && (t = 0), 'number' != typeof r && (r = l), this.slice)
                  )
            ...
            F = !1;
          if (
            (e.fn && e.fn.jquery ? ((g = e), (F = !0)) : (g = t.Velocity.Utilities), P <= 8 && !F)
          )
                    ...
                    register: function () {
                      ...
                      for (r in v.Hooks.templates)
                        if (v.Hooks.templates.hasOwnProperty(r)) {
                          ...
                          for (o in a)
                            a.hasOwnProperty(o) &&
                              ((s = r + a[o]), (l = o), (v.Hooks.registered[s] = [r, l]));
                        }
                    },
                    getRoot: function (e) {
                  ...
                  Normalizations: {
                    ...
                    register: function () {
                      function e(e, t, r) {
                        ...
                        if (
                          ('border-box' ===
                            ('' + v.getPropertyValue(t, 'boxSizing')).toLowerCase()) ===
                          (r || !1)
                        ) {
                          for (
                            i = 0,
                    ...
                    function s(e, r) {
                      ...
                      if (P <= 8) f = g.css(e, r);
                        ...
                        if (
                          ...
                          if (
                            'height' === r &&
                            'border-box' !== ('' + v.getPropertyValue(e, 'boxSizing')).toLowerCase()
                          )
                            return (
                              (u =
                                e.offsetHeight -
                    ...
                    if ('scroll' === r)
                      ...
                      if (
                        ...
                        try {
                          ...
                          y.debug &&
                            console.log('Browser does not support [' + n + '] for [' + c + ']');
                        }
                      else
                        (u = o(e)),
                  ...
                  flushTransformCache: function (e) {
                    ...
                    (P || (y.State.isAndroid && !y.State.isChrome)) && s && s.isSVG
                      ...
                      : (g.each(o(e).transformCache, function (t) {
                          if (((n = o(e).transformCache[t]), 'transformPerspective' === t))
                            return (a = n), !0;
              ...
              (x = function () {
                ...
                function a(e, a) {
                  function i(i) {
                    ...
                    if ('scroll' === N)
                          ...
                          : ((b = y.State.scrollAnchor[y.State['scrollProperty' + m]]),
                            (x =
                              y.State.scrollAnchor[
                                y.State['scrollProperty' + ('Left' === m ? 'Top' : 'Left')]
                              ]),
                      ...
                      for (E in u)
                        u.hasOwnProperty(E) &&
                          ...
                          y.debug &&
                            console.log(
                              'reverse tweensContainer (' + E + '): ' + JSON.stringify(u[E]),
                              e,
                            ));
                      f = u;
                    } else if ('start' === N) {
                      (l = o(e)),
                        ...
                        (j = function (a, i) {
                          ...
                          if (
                            ...
                            return void (
                              y.debug &&
                              console.log('Skipping [' + B + '] due to a lack of browser support.')
                            );
                          if (
                              ...
                              return (
                                ...
                                u && s
                                  ...
                                  : ((i =
                                    ...
                                    (a.percentToPxWidth = z.lastPercentToPxWidth =
                                      (parseFloat(v.getPropertyValue(i, 'width', null, !0)) || 1) /
                                      n),
                                    (a.percentToPxHeight = z.lastPercentToPxHeight =
                                      (parseFloat(v.getPropertyValue(i, 'height', null, !0)) || 1) /
                                      n),
                                    (a.emToPx = z.lastEmToPx =
                                ...
                                null === z.remToPx &&
                                  (z.remToPx =
                                    parseFloat(v.getPropertyValue(r.body, 'fontSize')) || 16),
                                null === z.vwToPx &&
                          ...
                          (f[a] = {
                            ...
                            y.debug &&
                              console.log(
                                'tweensContainer (' + a + '): ' + JSON.stringify(f[a]),
                                e,
                              );
                        });
                      for (q in S)
                        if (S.hasOwnProperty(q))
                          if (
                            ...
                            (M = O(S[q])),
                            C(v.Lists.colors, L) &&
                              (($ = M[0]), (B = M[1]), (W = M[2]), v.RegEx.isHex.test($)))
                          )
                            for (
                              I = ['Red', 'Green', 'Blue'],
                                D = v.Values.hexToRgb($),
                    ...
                    f.element &&
                      ...
                      (l = o(e)),
                      l &&
                        ('' === c.queue && ((l.tweensContainer = f), (l.opts = c)),
                        (l.isAnimating = !0)),
                      T === V - 1
                ...
                if (
                  (A.isWrapped(this)
                    ...
                    : ((c = !0),
                      (b = 1),
                      (w = W ? arguments[0].elements || arguments[0].e : arguments[0])),
                  ...
                  return void (
                    k.promise &&
                    (S && P && !1 === P.promiseRejectEmpty ? k.resolver() : k.rejecter())
                  );
                if (
                  ((V = w.length),
                  (T = 0),
                  !/^(stop|finish|finishAll|pause|resume)$/i.test(S) && !g.isPlainObject(P))
                )
                      ...
                      g.each(y.State.calls, function (e, t) {
                        t &&
                          g.each(t[1], function (r, a) {
                            var i = P === n ? '' : P;
                            if (!0 !== i && t[2].queue !== i && (P !== n || !1 !== t[2].queue))
                              return !0;
                        ...
                        ? ((u = g.extend({}, P)),
                          ...
                          g.each(w, function (e, t) {
                            parseFloat(u.stagger)
                              ...
                              u.drag &&
                                ((u.duration =
                                  parseFloat(j) || (/^(callout|transition)/.test(S) ? 1e3 : m)),
                                (u.duration = Math.max(
